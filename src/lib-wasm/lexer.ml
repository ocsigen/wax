    ...
    (List.to_seq
       [
         ...
         ( "i32x4.relaxed_trunc_f32x4_s",
           INSTR (VecUnOp (VecRelaxedTrunc Signed)) );
         ( "i32x4.relaxed_trunc_f32x4_u",
           INSTR (VecUnOp (VecRelaxedTrunc Unsigned)) );
         ...
         ( "i16x8.extmul_low_i8x16_s",
           INSTR (VecBinOp (VecExtMulLow (Signed, `_8))) );
         ...
         ( "i32x4.extmul_low_i16x8_s",
           INSTR (VecBinOp (VecExtMulLow (Signed, `_16))) );
         ...
         ( "i64x2.extmul_low_i32x4_s",
           INSTR (VecBinOp (VecExtMulLow (Signed, `_32))) );
         ...
         ( "i32x4.trunc_sat_f32x4_s",
           INSTR (VecUnOp (VecTruncSat (`F32, Signed))) );
         ( "i32x4.trunc_sat_f32x4_u",
           INSTR (VecUnOp (VecTruncSat (`F32, Unsigned))) );
         ...
         ( "f64x2.convert_low_i32x4_s",
           INSTR (VecUnOp (VecConvert (`F64, Signed))) );
         ( "f64x2.convert_low_i32x4_u",
           INSTR (VecUnOp (VecConvert (`F64, Unsigned))) );
...
let rec token_rec ctx lexbuf =
  ...
  | keyword -> (
      ...
      | Some tok -> tok
      | None -> (
          (* atomic mnemonics via the shared table (see {!Atomics}) *)
