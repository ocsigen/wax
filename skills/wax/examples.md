...
[`descriptor`/`describes` clauses](correspondence.md#descriptors). The
...
The [branch-hinting proposal](correspondence.md#branch-hints) marks
...
The [compilation-hints proposal](correspondence.md#branch-hints)
