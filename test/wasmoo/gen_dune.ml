  ...
  Array.iter
    (fun file ->
      if Filename.check_suffix file ".wat" then (
        ...
        printf " (action\n";
        printf
          "  (run wax --validate -W all=error --input-format wat --format wax \
           -o %%{target} ../wasm-source/%s)))\n"
          file;
        printf " (rule\n";
        printf "  (alias runtest)\n";
        ...
        printf " (action\n";
        printf
          "  (run wax --validate -W all=error --input-format wax --format wat \
           -o %%{target} ../wax/%s.wax.gen)))\n"
          base;
        printf " (rule\n";
        printf "  (alias runtest)\n";
        (*        printf "  (mode (promote (until-clean)))\n";*)
        ...
        printf " (action\n";
        printf
          "  (run wax --validate -W all=error --input-format wax --format wax \
           -o %%{target} ../wax/%s.wax.gen)))\n"
          base;
        printf " (rule\n";
        printf "  (alias runtest)\n";
