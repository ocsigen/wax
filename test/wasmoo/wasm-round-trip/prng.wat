...
(func $caml_lxm_next (export "caml_lxm_next") (param $v (ref eq)) (result i64)
  (local $data_2 (ref extern)) (local $a i64) (local $s i64) (local $q0 i64)
  (local $q1 i64) (local $z i64)
  (local.set $data_2 (call $caml_ba_get_data (local.get $v)))
  (local.set $a
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data_2) (i32.const 0)))
      (i64.shl
        (i64.extend_i32_u
          (call $ta_get_i32 (local.get $data_2) (i32.const 1)))
        (i64.const 32))))
  (local.set $s
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data_2) (i32.const 2)))
      (i64.shl
        (i64.extend_i32_u
          (call $ta_get_i32 (local.get $data_2) (i32.const 3)))
        (i64.const 32))))
  (local.set $q0
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data_2) (i32.const 4)))
      (i64.shl
        (i64.extend_i32_u
          (call $ta_get_i32 (local.get $data_2) (i32.const 5)))
        (i64.const 32))))
  (local.set $q1
    (i64.or
      (i64.extend_i32_u (call $ta_get_i32 (local.get $data_2) (i32.const 6)))
      (i64.shl
        (i64.extend_i32_u
          (call $ta_get_i32 (local.get $data_2) (i32.const 7)))
        (i64.const 32))))
  ...
  (local.set $s
    (i64.add (i64.mul (local.get $s) (i64.const 0xd1342543de82ef95))
      (local.get $a)))
  (call $ta_set_i32 (local.get $data_2) (i32.const 2)
    (i32.wrap_i64 (local.get $s)))
  (call $ta_set_i32 (local.get $data_2) (i32.const 3)
  ...
  (call $ta_set_i32 (local.get $data_2) (i32.const 4)
    (i32.wrap_i64 (local.get $q0)))
  (call $ta_set_i32 (local.get $data_2) (i32.const 5)
    (i32.wrap_i64 (i64.shr_u (local.get $q0) (i64.const 32))))
  (call $ta_set_i32 (local.get $data_2) (i32.const 6)
    (i32.wrap_i64 (local.get $q1)))
  (call $ta_set_i32 (local.get $data_2) (i32.const 7)
