...
(func $parse_int (export "parse_int")
  ...
  (result i32)
  (local $s (ref $string)) (local $len i32) (local $base i32)
  (local $sign i32) (local $signedness i32) (local $i i32)
  (local $threshold i32) (local $d i32) (local $res i32) (local $c i32)
...
(global $INT_ERRMSG (ref $string)
  (@string $string "int_of_string" ) ;; "int.of_string"
)
...
(func $format_int (export "format_int")
  ...
  (local $s (ref $string)) (local $uppercase i32) (local $base i32)
