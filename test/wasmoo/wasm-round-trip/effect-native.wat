...
(func $unhandled_effect_wrapper (param $start (ref $thunk))
  ...
  (local $v (ref eq)) (local $resume_res_1 (ref $continuation))
  (local $resume_res_0 (ref eq))
...
(func $resume_fiber (export "%resume")
  ...
  (local $resume_res_1 (ref $continuation)) (local $resume_res_0 (ref eq))
  ...
  (local.set $exn
    (block $handle_exception (result (ref eq))
      ...
      (return_call_ref $function_3 (local.get $resume_res_0)
...
(func $f_2 (export "%perform") (param $eff (ref eq)) (result (ref eq))
  ...
  (return_call_ref $function_1 (local.get $res_1) (local.get $res_0)
    (struct.get $closure $func (ref.cast (ref $closure) (local.get $res_0))))
)

;; Allocate a stack

(func $initial_cont (param $f (ref eq)) (param $x (ref eq)) (result (ref eq))
