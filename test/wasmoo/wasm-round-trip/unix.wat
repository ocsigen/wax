...
(@if $wasi
  (@then
    ...
    (import "wasi_errors" "error_messages"
      (global $error_messages (ref $block)))
  ...
  (@else
    ...
    (import "bindings" "stat"
      (func $stat (param anyref i32) (result (ref eq))))
    (import "bindings" "lstat"
      (func $lstat (param anyref i32) (result (ref eq))))
    ...
    (import "bindings" "opendir"
      (func $opendir (param anyref) (result anyref)))
    (import "bindings" "readdir"
      (func $readdir (param anyref) (result anyref)))
    ...
    (import "bindings" "readlink"
      (func $readlink (param anyref) (result anyref)))
    ...
    (import "bindings" "ftruncate"
      (func $ftruncate (param (ref eq) (ref eq))))
    ...
    (import "bindings" "open"
      (func $open_fn (param anyref i32 i32) (result i32)))
    (import "bindings" "write"
      (func $write (param i32 (ref extern) i32 i32 i64) (result i32)))
    (import "bindings" "write"
      (func $write'
        (param i32 (ref extern) i32 i32 nullexternref) (result i32)))
...
(@if $wasi
  (@then
    ...
    (func $unix_path_op
      ...
      (result (ref eq))
      (local $p_len i32) (local $p_addr i32) (local $p_fd i32)
      (local $res i32)
    ...
    (global $error_codes (ref $constr_table)
      (array.new_fixed $constr_table 77 (i32.const -1) (i32.const 0)
        (i32.const 1) (i32.const 50) (i32.const 51) (i32.const 49)
        (i32.const 2) (i32.const 39) (i32.const 3) (i32.const -1)
        (i32.const 4) (i32.const -1) (i32.const 5) (i32.const 55)
        (i32.const 63) (i32.const 56) (i32.const 6) (i32.const 41)
        (i32.const 7) (i32.const -1) (i32.const 8) (i32.const 9)
        (i32.const 10) (i32.const 65) (i32.const -1) (i32.const -1)
        (i32.const 38) (i32.const 11) (i32.const 12) (i32.const 13)
        (i32.const 58) (i32.const 14) (i32.const 66) (i32.const 15)
        (i32.const 16) (i32.const 42) (i32.const -1) (i32.const 17)
        (i32.const 52) (i32.const 54) (i32.const 53) (i32.const 18)
        (i32.const 57) (i32.const 19) (i32.const 20) (i32.const 21)
        (i32.const 22) (i32.const -1) (i32.const 23) (i32.const -1)
        (i32.const 44) (i32.const 24) (i32.const 25) (i32.const 59)
        (i32.const 26) (i32.const 27) (i32.const -1) (i32.const 40)
        (i32.const 47) (i32.const 28) (i32.const 29) (i32.const 67)
        (i32.const -1) (i32.const 30) (i32.const 31) (i32.const -1)
        (i32.const 45) (i32.const 43) (i32.const 32) (i32.const 33)
        (i32.const 34) (i32.const 35) (i32.const -1) (i32.const 62)
        (i32.const -1) (i32.const 36) (i32.const -1)))
    ...
    (func $caml_unix_error
      (param $errcode i32) (param $cmd_name (ref eq))
      (param $cmd_arg (ref eq))
    ...
    (func $unix_error_message (export "unix_error_message")
      (export "caml_unix_error_message")
  ...
  (@else
    ...
    (func $caml_unix_error (param $exception externref) (param $cmd eqref)
      ...
      (local $errno (ref eq))
      (local.set $exn
        (call $wrap (any.convert_extern (local.get $exception))))
      (local.set $code
...
(@if $wasi
  (@then
    (func $unix_gettimeofday (export "unix_gettimeofday")
      ...
      (local.set $res
        (call $clock_time_get (i32.const 0) (i64.const 1000)
          (local.get $buffer)))
...
(@if $wasi
  (@then
    (func $unix_times (export "unix_times") (export "caml_unix_times")
      ...
      (local.set $buffer (call $get_buffer))
      (local.set $res
        (call $clock_time_get (i32.const 2) (i64.const 1)
          (local.get $buffer)))
  ...
  (@else
    (func $caml_alloc_times (export "caml_alloc_times")
      ...
      (array.new_fixed $float_array 4 (local.get $u) (local.get $s)
  ...
  (@then
    (func $caml_unix_mktime (export "caml_unix_mktime") (export "unix_mktime")
      ...
      (if (i64.eq (local.get $time) (i64.const -1))
        (then
          (call $caml_unix_error (i32.const 68) (; ERANGE ;)
...
(@if $wasi
  (@then
    (global $utimes_str (ref $bytes) (@string "utimes"))
    ...
    (func $unix_utimes (export "unix_utimes") (export "caml_unix_utimes")
      ...
      (local $mt f64) (local $set_to_now i32) (local $atim i64)
      (local $mtim i64) (local $res i32)
...
(@if $wasi
  (@then
    (global $file_kinds (ref $constr_table)
      (array.new_fixed $constr_table 8 (i32.const 3) (i32.const 3)
        (i32.const 2) (i32.const 1) (i32.const 0) (i32.const 6) (i32.const 6)
        (i32.const 4)))
    ...
    (func $alloc_stat (param $large i32) (param $p i32) (result (ref eq))
      (array.new_fixed $block 13 (ref.i31 (i32.const 0))
        ...
        (if (result (ref eq)) (local.get $large)
          (then
            (call $caml_copy_int64 (i64.load $m offset=32 (local.get $p))))
          (else
            (ref.i31 (i32.wrap_i64 (i64.load $m offset=32 (local.get $p))))))
        (struct.new $float
...
(@if $wasi
  (@then
    ...
    (func $unix_lstat_64 (export "unix_lstat_64")
      (export "caml_unix_lstat_64") (param $path (ref eq)) (result (ref eq))
    ...
    (func $unix_fstat_64 (export "unix_fstat_64")
      (export "caml_unix_fstat_64") (param $fd (ref eq)) (result (ref eq))
...
(@if $wasi
  (@then
    (global $chmod_str (ref $bytes) (@string "chmod"))
...
(@if $wasi
  (@then
    (global $rename_str (ref $bytes) (@string "rename"))
...
(@if $wasi
  (@then
    (global $chdir_str (ref $bytes) (@string "chdir"))
...
(@if $wasi
  (@then
    (global $mkdir_str (ref $bytes) (@string "mkdir"))
...
(@if $wasi
  (@then
    ...
    (func $is_dot_entry (param $addr i32) (param $len i32) (result i32)
      ...
      (if (i32.eq (local.get $len) (i32.const 1))
        (then
          (return
            (i32.eq (i32.load8_u $m (local.get $addr)) (i32.const 0x2e)))))
    ...
    (func $readdir_helper (param $vdir (ref eq)) (result (ref eq))
      ...
      (block $no_dots
        ...
        (if
          (i32.eq (struct.get $directory $dots (local.get $dir))
            (i32.const 2))
          (then
    ...
    (func $unix_closedir (export "unix_closedir")
      (export "caml_unix_closedir") (param $vdir (ref eq)) (result (ref eq))
    ...
    (func $unix_rewinddir (export "unix_rewinddir")
      (export "caml_unix_rewinddir") (param $vdir (ref eq)) (result (ref eq))
  ...
  (@else
    ...
    (func $unix_closedir (export "unix_closedir")
      (export "caml_unix_closedir") (export "win_findclose")
      (export "caml_unix_findclose") (param $dir (ref eq)) (result (ref eq))
      (try
    ...
    (func $unix_rewinddir (export "unix_rewinddir")
      (export "caml_unix_rewinddir") (param (ref eq)) (result (ref eq))
...
(@if $wasi
  (@then
    (global $unlink_str (ref $bytes) (@string "unlink"))
...
(@if $wasi
  (@then
    (global $rmdir_str (ref $bytes) (@string "rmdir"))
...
(@if $wasi
  (@then
    (global $link_str (ref $bytes) (@string "link"))
...
(@if $wasi
  (@then
    (global $symlink_str (ref $bytes) (@string "symlink"))
    ...
    (func $unix_symlink (export "unix_symlink") (export "caml_unix_symlink")
      ...
      (local $op i32) (local $np_len i32) (local $np_addr i32)
      (local $np_fd i32) (local $arg (ref eq)) (local $res i32)
      ...
      (block $error
        ...
        (local.set $arg (local.get $o))
        (local.set $res
          (call $path_symlink (local.get $op) (local.get $len)
            (local.get $np_fd) (local.get $np_addr) (local.get $np_len))))
...
(@if $wasi
  (@then
    (global $readlink_str (ref $bytes) (@string "readlink"))

    (func $unix_readlink (export "unix_readlink")
      (export "caml_unix_readlink") (param $path (ref eq)) (result (ref eq))
      (local $p_len i32) (local $p_addr i32) (local $p_fd i32)
...
(@if $wasi
  (@then
    (global $truncate_str (ref $bytes) (@string "truncate"))

    (func $truncate_impl
      (param $path (ref eq)) (param $len i64) (result (ref eq))
      (local $res i32) (local $p_len i32) (local $p_addr i32)
      (local $p_fd i32) (local $buffer i32) (local $fd i32)
      (block $error
    ...
    (func $unix_truncate (export "unix_truncate")
      (export "caml_unix_truncate")
...
(@if $wasi
  (@then
    ...
    (func $unix_ftruncate (export "unix_ftruncate")
      (export "caml_unix_ftruncate")
...
(@if $wasi
  (@then
    (global $access_str (ref $bytes) (@string "access"))
  ...
  (@else
    ...
    (func $unix_access (export "unix_access") (export "caml_unix_access")
      ...
      (local $flags i32)
      (local.set $flags
        (call $convert_flag_list (global.get $access_flags)
          (local.get $vflags)))
      (try
        (do
          (call $access
...
(@if $wasi
  (@then
    ...
    (func $unix_open (export "unix_open") (export "caml_unix_open")
      ...
      (local $path_fd i32) (local $buffer i32) (local $flags i32)
      (local $res i32)
  ...
  (@else
    ...
    (global $unix_open_flags (ref $flags)
      (array.new_fixed $flags 15 (i32.const 1) (i32.const 2) (i32.const 4)
        (i32.const 128) (i32.const 8) (i32.const 16) (i32.const 32)
        (i32.const 64) (i32.const 256) (i32.const 512) (i32.const 1024)
...
(@if $wasi
  (@then
    (func $unix_write (export "unix_write") (export "caml_unix_write")
      ...
      (local $fd i32) (local $s (ref $bytes)) (local $pos i32)
      (local $len i32) (local $buffer i32) (local $nwritten i32)
    ...
    (func $unix_single_write (export "unix_single_write")
      ...
      (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
      (param $vlen (ref eq)) (result (ref eq))
      (local $written i32) (local $n i32) (local $fd i32)
      (local $s (ref $bytes)) (local $pos i32) (local $len i32)
    ...
    (func $unix_read (export "unix_read") (export "caml_unix_read")
      ...
      (local $nread i32) (local $iovs i32) (local $iovs_len i32)
    ...
    (func $unix_write_bigarray (export "unix_write_bigarray")
      ...
      (local $pos i32) (local $len i32) (local $buffer i32)
      (local $nwritten i32) (local $iovs i32) (local $iovs_len i32)
      (local $written i32) (local $numbytes i32) (local $res i32)
      (local $n i32)
      (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
      (local.set $dat
        (ref.cast (ref $dat)
        ...
        (if (i32.gt_u (local.get $len) (i32.const 0))
          (then
            (local.set $numbytes
              (select (global.get $IO_BUFFER_SIZE) (local.get $len)
                (i32.gt_u (local.get $len) (global.get $IO_BUFFER_SIZE))))
            (call $blit_substring_to_memory (local.get $buffer)
              (local.get $buf) (local.get $pos) (local.get $numbytes))
            (i32.store $m offset=4 (local.get $iovs) (local.get $numbytes))
            (local.set $res
              (call $fd_write (local.get $fd) (local.get $iovs)
                (local.get $iovs_len) (local.get $nwritten)))
  ...
  (@else
    (func $unix_write (export "unix_write") (export "caml_unix_write")
      ...
      (param $vlen (ref eq)) (result (ref eq))
      (local $fd i32) (local $s (ref $bytes)) (local $pos i32)
      (local $len i32) (local $buf (ref extern))
      (local $buf_view (ref extern)) (local $fd_offset (ref $fd_offset))
      (local $offset i64) (local $written i32) (local $numbytes i32)
      (local $n i32)
      (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
      (local.set $s (ref.cast (ref $bytes) (local.get $vbuf)))
      (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
    ...
    (func $unix_single_write (export "unix_single_write")
      ...
      (local $len i32) (local $buf (ref extern))
      (local $buf_view (ref extern)) (local $fd_offset (ref $fd_offset))
      (local $offset i64) (local $n i32) (local $numbytes i32)
      (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
      (local.set $s (ref.cast (ref $bytes) (local.get $vbuf)))
      (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
      (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
    ...
    (func $unix_read (export "unix_read") (export "caml_unix_read")
      (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
      (param $vlen (ref eq)) (result (ref eq))
      (local $fd i32) (local $pos i32) (local $len i32)
    ...
    (func $unix_write_bigarray (export "unix_write_bigarray")
      ...
      (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
      (param $vlen (ref eq)) (param $vsingle (ref eq)) (result (ref eq))
      (local $fd i32) (local $buf (ref extern)) (local $pos i32)
      (local $len i32) (local $fd_offset (ref $fd_offset)) (local $offset i64)
...
(@if $wasi
  ...
  (@else
    (func $lseek_exn (param $errno i32) (result (ref eq))
      (array.new_fixed $block 5 (ref.i31 (i32.const 0))
        (call $get_unix_error_exn) (ref.i31 (local.get $errno))
        (@string "lseek") (global.get $no_arg)))
...
(@if $wasi
  (@then
    (func $caml_unix_check_stream_semantics
      (param $fd (ref eq)) (param $out i32)
