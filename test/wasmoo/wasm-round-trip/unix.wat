...
(@if $wasi
(@then (type $path_op (func (param i32 i32 i32) (result i32)))
...
(import "wasi_snapshot_preview1" "path_create_directory"
  (func $path_create_directory (type $path_op))
)
(import "wasi_snapshot_preview1" "path_unlink_file"
  (func $path_unlink_file (type $path_op))
)
(import "wasi_snapshot_preview1" "path_remove_directory"
  (func $path_remove_directory (type $path_op))
)
...
(@else (import "bindings" "gettimeofday" (func $gettimeofday (result f64)))
...
(import "bindings" "access" (func $access (param anyref i32)))
(import "bindings" "open" (func $open_fn (param anyref i32 i32) (result i32)))
...
(func $isatty (export "unix_isatty") (export "caml_unix_isatty")
...
(type $fd_offset
  (struct
    ...
    (field $seeked (mut i32))
    (field $append (mut i32)))
)

(global $unix_error_exn (mut (ref eq)) (ref.i31 (i32.const 0)))

(global $unix_error_str (ref $bytes) (@string "Unix.Unix_error" ))

(global $unix_error_not_initialized (ref $bytes)
  (@string "Exception Unix.Unix_error not initialized, please link unix.cma" )
)
...
(func $unix_resolve_path (export "unix_resolve_path")
  ...
  (if (i32.lt_s (local.get $res_0) (i32.const 0))
    (then
      (call $caml_unix_error (i32.const 44) ;; ENOENT
...
;; Resolve $path, invoke a path-based syscall $f on it, free the
;; resolved buffer and raise a Unix_error labelled $cmd on failure.
(func $unix_path_op
  (param $cmd (ref eq)) (param $path (ref eq)) (param $f (ref $path_op))
  (result (ref eq))
  (local $p_len i32) (local $p_addr i32) (local $p_fd i32) (local $res i32)
  (call $unix_resolve_path (local.get $cmd) (local.get $path))
  (local.set $p_len)
  (local.set $p_addr)
  (local.set $p_fd)
  (local.set $res
    (call_ref $path_op (local.get $p_fd) (local.get $p_addr)
      (local.get $p_len) (local.get $f)))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (local.get $cmd)
    (local.get $path))
  (ref.i31 (i32.const 0))
)
...
(global $error_codes (ref $constr_table)
  (array.new_fixed $constr_table 77 (i32.const -1) (i32.const 0) (i32.const 1)
    (i32.const 50) (i32.const 51) (i32.const 49) (i32.const 2) (i32.const 39)
    (i32.const 3) (i32.const -1) (i32.const 4) (i32.const -1) (i32.const 5)
    (i32.const 55) (i32.const 63) (i32.const 56) (i32.const 6) (i32.const 41)
    (i32.const 7) (i32.const -1) (i32.const 8) (i32.const 9) (i32.const 10)
    (i32.const 65) (i32.const -1) (i32.const -1) (i32.const 38) (i32.const 11)
    (i32.const 12) (i32.const 13) (i32.const 58) (i32.const 14) (i32.const 66)
    (i32.const 15) (i32.const 16) (i32.const 42) (i32.const -1) (i32.const 17)
    (i32.const 52) (i32.const 54) (i32.const 53) (i32.const 18) (i32.const 57)
    (i32.const 19) (i32.const 20) (i32.const 21) (i32.const 22) (i32.const -1)
    (i32.const 23) (i32.const -1) (i32.const 44) (i32.const 24) (i32.const 25)
    (i32.const 59) (i32.const 26) (i32.const 27) (i32.const -1) (i32.const 40)
    (i32.const 47) (i32.const 28) (i32.const 29) (i32.const 67) (i32.const -1)
    (i32.const 30) (i32.const 31) (i32.const -1) (i32.const 45) (i32.const 43)
    (i32.const 32) (i32.const 33) (i32.const 34) (i32.const 35) (i32.const -1)
...
(global $error_names (ref $block)
  (array.new_fixed $block 68 (@string "E2BIG" ) (@string "EACCES" )
    (@string "EAGAIN" ) (@string "EBADF" ) (@string "EBUSY" )
    (@string "ECHILD" ) (@string "EDEADLK" ) (@string "EDOM" )
    (@string "EEXIST" ) (@string "EFAULT" ) (@string "EFBIG" )
    (@string "EINTR" ) (@string "EINVAL" ) (@string "EIO" )
    (@string "EISDIR" ) (@string "EMFILE" ) (@string "EMLINK" )
    (@string "ENAMETOOLONG" ) (@string "ENFILE" ) (@string "ENODEV" )
    (@string "ENOENT" ) (@string "ENOEXEC" ) (@string "ENOLCK" )
    (@string "ENOMEM" ) (@string "ENOSPC" ) (@string "ENOSYS" )
    (@string "ENOTDIR" ) (@string "ENOTEMPTY" ) (@string "ENOTTY" )
    (@string "ENXIO" ) (@string "EPERM" ) (@string "EPIPE" )
    (@string "ERANGE" ) (@string "EROFS" ) (@string "ESPIPE" )
    (@string "ESRCH" ) (@string "EXDEV" ) (@string "EWOULDBLOCK" )
    (@string "EINPROGRESS" ) (@string "EALREADY" ) (@string "ENOTSOCK" )
    (@string "EDESTADDRREQ" ) (@string "EMSGSIZE" ) (@string "EPROTOTYPE" )
    (@string "ENOPROTOOPT" ) (@string "EPROTONOSUPPORT" )
    (@string "ESOCKTNOSUPPORT" ) (@string "EOPNOTSUPP" )
    (@string "EPFNOSUPPORT" ) (@string "EAFNOSUPPORT" )
  ...
  (if (i32.le_u (local.get $errcode) (i32.const 76))
    (then
      ...
      (if (i32.ne (local.get $err) (i32.const -1))
        (then (return (ref.i31 (local.get $err)))))))
...
(func $caml_unix_error
  ...
  (throw $ocaml_exception
    (array.new_fixed $block 5 (ref.i31 (i32.const 0))
      ...
      (local.get $cmd_name) (local.get $cmd_arg)))
)

(func $caml_unix_error_if
  (param $errcode i32) (param $cmd_name (ref eq)) (param $cmd_arg (ref eq))
  (if (local.get $errcode)
    (then
      (call $caml_unix_error (local.get $errcode) (local.get $cmd_name)
        (local.get $cmd_arg))))
)

(func $unix_error_message (export "unix_error_message")
  (export "caml_unix_error_message") (param $err (ref eq)) (result (ref eq))
  (local $i i32) (local $errcode i32) (local $n i32)
  (if (ref.test (ref i31) (local.get $err))
    (then
      (local.set $n (i31.get_u (ref.cast (ref i31) (local.get $err))))
      (loop $loop
        (if
          (i32.lt_u (local.get $errcode)
          ...
          (then
            (if
              ...
              (then
                ...
                (br $loop))))
          (else (local.set $errcode (i32.const -1))))))
    (else
      (local.set $errcode
        (i31.get_u
          (ref.cast (ref i31)
            (array.get $block (ref.cast (ref $block) (local.get $err))
              (i32.const 1)))))))
  (if (i32.ge_u (local.get $errcode) (array.len (global.get $error_messages)))
    (then
      ...
      (if
        (i32.and (ref.test (ref i31) (local.get $err))
          (i32.lt_u (local.get $n) (array.len (global.get $error_names))))
        (then
          (return
            (array.get $block (global.get $error_names) (local.get $n)))))
      (return_call $caml_string_concat (@string "Unknown error " )
...
(func $ensure_string (param $s (ref eq)) (result (ref eq))
  ...
  (drop
    (block $not_jsstring (result anyref)
      (local.set $str
        (struct.get $js $js
          (br_on_cast_fail $not_jsstring (ref eq) (ref $js) (local.get $s))))
      (drop
...
(global $code_str (ref $bytes) (@string "code" ))
(global $errno_str (ref $bytes) (@string "errno" ))
(global $indexOf (ref $bytes) (@string "indexOf" ))
(global $syscall (ref $bytes) (@string "syscall" ))
(global $path (ref $bytes) (@string "path" ))

(func $caml_unix_error (param $exception externref) (param $cmd eqref)
  (local $exn (ref eq)) (local $code (ref eq)) (local $variant (ref eq))
  (local $errno (ref eq))
  (local.set $exn (call $wrap (any.convert_extern (local.get $exception))))
  (local.set $code
    (call $caml_js_get (local.get $exn) (global.get $code_str)))
  (local.set $variant
    (call $caml_js_meth_call (global.get $unix_error) (global.get $indexOf)
      (array.new_fixed $block 2 (ref.i31 (i32.const 0)) (local.get $code))))
  ...
  (throw $ocaml_exception
    (array.new_fixed $block 5 (ref.i31 (i32.const 0))
      (call $get_unix_error_exn) (local.get $variant)
      (if (result (ref eq)) (ref.is_null (local.get $cmd))
        (then
          (call $ensure_string
            (call $caml_js_get (local.get $exn) (global.get $syscall))))
        (else (ref.as_non_null (local.get $cmd))))
      (call $ensure_string
...
(func $unix_error_message (export "unix_error_message")
  ...
  (local.set $errno
    (if (result i32) (ref.test (ref i31) (local.get $err))
      (then (i31.get_u (ref.cast (ref i31) (local.get $err))))
      (else
        (i32.sub (i32.const 0)
          (i31.get_u
            (ref.cast (ref i31)
...
(func $unix_gettimeofday (export "unix_gettimeofday")
  ...
  (local.set $res
    (call $clock_time_get (i32.const 0) (i64.const 1000) (local.get $buffer)))
  (call $caml_unix_error_if (local.get $res) (@string "gettimeofday" )
    (global.get $no_arg))
  (struct.new $float
    (f64.mul (f64.convert_i64_u (i64.load $m (local.get $buffer)))
      (f64.const 1e-9)))
) )
(@else
(func $unix_gettimeofday (export "unix_gettimeofday")
...
(@if $wasi
(@then
(func $unix_times (export "unix_times") (export "caml_unix_times")
  (param (ref eq)) (result (ref eq))
  (local $buffer i32) (local $res i32)
  (local.set $buffer (call $get_buffer))
  (local.set $res
  ...
  (if (i32.eq (local.get $res) (i32.const 8))
    (then
      (local.set $res
        (call $clock_time_get (i32.const 1) (i64.const 1)
          (local.get $buffer)))))
  (call $caml_unix_error_if (local.get $res) (@string "time" )
    (global.get $no_arg))
  (array.new_fixed $float_array 4
    (f64.mul (f64.convert_i64_u (i64.load $m (local.get $buffer)))
      (f64.const 1e-9)) (f64.const 0) (f64.const 0) (f64.const 0))
) )
(@else
(func $caml_alloc_times (export "caml_alloc_times")
  (param $u f64) (param $s f64) (result (ref eq))
  (array.new_fixed $float_array 4 (local.get $u) (local.get $s) (f64.const 0)
    (f64.const 0))
)
...
(func $alloc_tm (param $tm i32) (result (ref eq))
  (array.new_fixed $block 10 (ref.i31 (i32.const 0))
    (ref.i31 (i32.load $m (local.get $tm)))
    (ref.i31 (i32.load $m offset=4 (local.get $tm)))
    (ref.i31 (i32.load $m offset=8 (local.get $tm)))
    (ref.i31 (i32.load $m offset=12 (local.get $tm)))
    (ref.i31 (i32.load $m offset=16 (local.get $tm)))
    (ref.i31 (i32.load $m offset=20 (local.get $tm)))
    (ref.i31 (i32.load $m offset=24 (local.get $tm)))
    (ref.i31 (i32.load $m offset=28 (local.get $tm)))
    (ref.i31
      (select (i32.const 1) (i32.const 0)
        (i32.load $m offset=32 (local.get $tm)))))
) )
(@else
...
(@if $wasi
(@then
(func $caml_unix_gmtime (export "caml_unix_gmtime") (export "unix_gmtime")
  (param $t (ref eq)) (result (ref eq))
  (local $buffer i32) (local $tm i32)
  (local.set $buffer (call $get_buffer))
  (i64.store $m (local.get $buffer)
    (i64.trunc_sat_f64_s
      (struct.get $float $f (ref.cast (ref $float) (local.get $t)))))
  (local.set $tm (call $gmtime (local.get $buffer)))
  (if (i32.eqz (local.get $tm))
    (then
      (call $caml_unix_error (i32.const 28) (; EINVAL ;) (@string "gmtime" )
        (global.get $no_arg))))
...
(func $caml_unix_gmtime (export "caml_unix_gmtime") (export "unix_gmtime")
  (param $t (ref eq)) (result (ref eq))
  (call $gmtime (struct.get $float $f (ref.cast (ref $float) (local.get $t))))
) ) )

(@if $wasi
(@then
(func $caml_unix_localtime (export "caml_unix_localtime")
  (export "unix_localtime") (param $t (ref eq)) (result (ref eq))
  (local $buffer i32) (local $tm i32)
  (local.set $buffer (call $get_buffer))
  (i64.store $m (local.get $buffer)
    (i64.trunc_sat_f64_s
...
(@if $wasi
(@then
(func $caml_unix_time (export "caml_unix_time") (export "unix_time")
  (param (ref eq)) (result (ref eq))
  (local $buffer i32) (local $res i32)
  (local.set $buffer (call $get_buffer))
  (local.set $res
...
(@if $wasi
(@then
(func $caml_unix_mktime (export "caml_unix_mktime") (export "unix_mktime")
  (param $v (ref eq)) (result (ref eq))
  (local $t (ref $block)) (local $tm i32) (local $time i64)
  (local.set $t (ref.cast (ref $block) (local.get $v)))
  (local.set $tm (call $get_buffer))
  (i32.store $m (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 1)))))
  (i32.store $m offset=4 (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 2)))))
  (i32.store $m offset=8 (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 3)))))
  (i32.store $m offset=12 (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 4)))))
  (i32.store $m offset=16 (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 5)))))
  (i32.store $m offset=20 (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 6)))))
  (i32.store $m offset=24 (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 7)))))
  (i32.store $m offset=28 (local.get $tm)
    (i31.get_s
      (ref.cast (ref i31) (array.get $block (local.get $t) (i32.const 8)))))
  (i32.store $m offset=32 (local.get $tm) (i32.const -1))
  (local.set $time (call $mktime (local.get $tm)))
  (if (i64.eq (local.get $time) (i64.const -1))
    (then
      (call $caml_unix_error (i32.const 68) (; ERANGE ;) (@string "mktime" )
        (global.get $no_arg))))
...
(@if $wasi
(@then (global $utimes_str (ref $bytes) (@string "utimes" ))

(func $unix_utimes (export "unix_utimes") (export "caml_unix_utimes")
  (param $path (ref eq)) (param $atime (ref eq)) (param $mtime (ref eq))
  (result (ref eq))
  (local $p_len i32) (local $p_addr i32) (local $p_fd i32) (local $at f64)
  (local $mt f64) (local $set_to_now i32) (local $atim i64) (local $mtim i64)
  (local $res i32)
  ...
  (local.set $p_fd)
  (local.set $at
    (struct.get $float $f (ref.cast (ref $float) (local.get $atime))))
  (local.set $mt
    (struct.get $float $f (ref.cast (ref $float) (local.get $mtime))))
  ...
  (if (i32.eqz (local.get $set_to_now))
    (then
      (local.set $atim
        (i64.trunc_sat_f64_s (f64.mul (local.get $at) (f64.const 1e9))))
      (local.set $mtim
        (i64.trunc_sat_f64_s (f64.mul (local.get $mt) (f64.const 1e9))))))
  (local.set $res
    (call $path_filestat_set_times (local.get $p_fd)
      (i32.const 1) ;; symlink_follow, like every other path op and native
      (local.get $p_addr) (local.get $p_len) (local.get $atim)
      (local.get $mtim) (i32.shl (i32.const 5) (local.get $set_to_now))))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $utimes_str)
    (local.get $path))
  (ref.i31 (i32.const 0))
) )
(@else
(func $unix_utimes (export "unix_utimes") (export "caml_unix_utimes")
  ...
  (try
    ...
    (catch $javascript_exception (call $caml_unix_error (ref.null eq))))
  (ref.i31 (i32.const 0))
) ) )
...
(global $file_kinds (ref $constr_table)
  (array.new_fixed $constr_table 8 (i32.const 3) (i32.const 3) (i32.const 2)
    (i32.const 1) (i32.const 0) (i32.const 6) (i32.const 6) (i32.const 4))
)

(func $alloc_stat (param $large i32) (param $p i32) (result (ref eq))
  (array.new_fixed $block 13 (ref.i31 (i32.const 0))
    (ref.i31 (i32.wrap_i64 (i64.load $m (local.get $p))))
    (ref.i31 (i32.wrap_i64 (i64.load $m offset=8 (local.get $p))))
    (ref.i31
      (array.get_s $constr_table (global.get $file_kinds)
        (i32.load8_u $m offset=16 (local.get $p))))
    (ref.i31 (i32.const 384) (;0600;) )
    (ref.i31 (i32.wrap_i64 (i64.load $m offset=24 (local.get $p))))
    (ref.i31 (i32.const 1)) (ref.i31 (i32.const 1)) (ref.i31 (i32.const 0))
    (if (result (ref eq)) (local.get $large)
      (then (call $caml_copy_int64 (i64.load $m offset=32 (local.get $p))))
      (else (ref.i31 (i32.wrap_i64 (i64.load $m offset=32 (local.get $p))))))
    (struct.new $float
      (f64.mul (f64.const 1e-9)
        (f64.convert_i64_s (i64.load $m offset=40 (local.get $p)))))
    (struct.new $float
      (f64.mul (f64.const 1e-9)
        (f64.convert_i64_s (i64.load $m offset=48 (local.get $p)))))
    (struct.new $float
      (f64.mul (f64.const 1e-9)
        (f64.convert_i64_s (i64.load $m offset=56 (local.get $p))))))
) ) )

(func $caml_alloc_stat (export "caml_alloc_stat")
  (param $large i32) (param $dev i32) (param $ino i32) (param $kind i32)
  (param $perm i32) (param $nlink i32) (param $uid i32) (param $gid i32)
  (param $rdev i32) (param $size i64) (param $atime f64) (param $mtime f64)
  (param $ctime f64) (result (ref eq))
  (array.new_fixed $block 13 (ref.i31 (i32.const 0))
    (ref.i31 (local.get $dev)) (ref.i31 (local.get $ino))
    (ref.i31 (local.get $kind)) (ref.i31 (local.get $perm))
    (ref.i31 (local.get $nlink)) (ref.i31 (local.get $uid))
    (ref.i31 (local.get $gid)) (ref.i31 (local.get $rdev))
    (if (result (ref eq)) (local.get $large)
...
(func $stat
  ...
  (local $p_len i32) (local $p_addr i32) (local $p_fd i32) (local $buffer i32)
  (local $res i32)
  ...
  (local.set $buffer (call $get_buffer))
  (local.set $res
    (call $path_filestat_get (local.get $p_fd)
      (local.get $follow) ;; symlink_follow
      (local.get $p_addr) (local.get $p_len) (local.get $buffer)))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (local.get $name)
    (local.get $path))
  (return_call $alloc_stat (local.get $large) (local.get $buffer))
)

(global $stat_str (ref $bytes) (@string "stat" ))

(func $unix_stat (export "unix_stat") (export "caml_unix_stat")
  (param $path (ref eq)) (result (ref eq))
  (return_call $stat (local.get $path) (i32.const 0) (i32.const 1)
    (global.get $stat_str))
)

(func $unix_stat_64 (export "unix_stat_64") (export "caml_unix_stat_64")
  (param $path (ref eq)) (result (ref eq))
  (return_call $stat (local.get $path) (i32.const 1) (i32.const 1)
    (global.get $stat_str))
)

(global $lstat_str (ref $bytes) (@string "lstat" ))

(func $unix_lstat (export "unix_lstat") (export "caml_unix_lstat")
  (param $path (ref eq)) (result (ref eq))
  (return_call $stat (local.get $path) (i32.const 0) (i32.const 0)
    (global.get $lstat_str))
)

(func $unix_lstat_64 (export "unix_lstat_64") (export "caml_unix_lstat_64")
  (param $path (ref eq)) (result (ref eq))
  (return_call $stat (local.get $path) (i32.const 1) (i32.const 0)
    (global.get $lstat_str))
)
...
(func $fstat (param $fd (ref eq)) (param $large i32) (result (ref eq))
  ...
  (local.set $buffer (call $get_buffer))
  (local.set $res
    (call $fd_filestat_get (i31.get_u (ref.cast (ref i31) (local.get $fd)))
      (local.get $buffer)))
  (call $caml_unix_error_if (local.get $res) (@string "fstat" )
    (global.get $no_arg))
  (return_call $alloc_stat (local.get $large) (local.get $buffer))
)

(func $unix_fstat (export "unix_fstat") (export "caml_unix_fstat")
  (param $fd (ref eq)) (result (ref eq))
  (return_call $fstat (local.get $fd) (i32.const 0))
)

(func $unix_fstat_64 (export "unix_fstat_64") (export "caml_unix_fstat_64")
  (param $fd (ref eq)) (result (ref eq))
...
(func $unix_fstat (export "unix_fstat") (export "caml_unix_fstat")
  (param $fd (ref eq)) (result (ref eq))
  (try (result (ref eq))
    (do (call $fstat (local.get $fd) (i32.const 0)))
    (catch $javascript_exception
      (call $caml_unix_error (ref.null eq))
      (ref.i31 (i32.const 0))))
)
...
(func $unix_fstat_64 (export "unix_fstat_64") (export "caml_unix_fstat_64")
  (param $fd (ref eq)) (result (ref eq))
  (try (result (ref eq))
    (do (call $fstat (local.get $fd) (i32.const 1)))
    (catch $javascript_exception
      (call $caml_unix_error (ref.null eq))
      (ref.i31 (i32.const 0))))
) ) )
...
(@if $wasi
(@then (global $chmod_str (ref $bytes) (@string "chmod" ))

(func $unix_chmod (export "unix_chmod") (export "caml_unix_chmod")
  ...
  (local.set $buffer (call $get_buffer))
  (local.set $res
    (call $path_filestat_get (local.get $p_fd) (i32.const 1)
      (local.get $p_addr) (local.get $p_len) (local.get $buffer)))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $chmod_str)
    (local.get $path))
  (ref.i31 (i32.const 0))
) )
(@else
...
(@if $wasi
(@then
(func $unix_fchmod (export "unix_fchmod") (export "caml_unix_fchmod")
...
(func $unix_fchmod (export "unix_fchmod") (export "caml_unix_fchmod")
  ...
  (try
    (do (call $fchmod (local.get $fd) (local.get $perms)))
    (catch $javascript_exception (call $caml_unix_error (ref.null eq))))
  (ref.i31 (i32.const 0))
) ) )

(@if $wasi
(@then (global $rename_str (ref $bytes) (@string "rename" ))

(func $unix_rename (export "unix_rename") (export "caml_unix_rename")
  (param $o (ref eq)) (param $n (ref eq)) (result (ref eq))
  (local $op_len i32) (local $op_addr i32) (local $op_fd i32)
  (local $np_len i32) (local $np_addr i32) (local $np_fd i32)
  (local $arg (ref eq)) (local $res i32)
  ...
  (block $error
    (br_if $error (i32.lt_s (local.get $op_fd) (i32.const 0)))
    (local.set $arg (local.get $n))
    (br_if $error (i32.lt_s (local.get $np_fd) (i32.const 0)))
    (local.set $arg (local.get $o))
    (local.set $res
      (call $path_rename (local.get $op_fd) (local.get $op_addr)
        (local.get $op_len) (local.get $np_fd) (local.get $np_addr)
        (local.get $np_len))))
  (call $free (local.get $op_addr))
  (call $free (local.get $np_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $rename_str)
    (local.get $arg))
  (ref.i31 (i32.const 0))
) )
(@else
...
(@if $wasi
(@then (global $chdir_str (ref $bytes) (@string "chdir" ))

(func $unix_chdir (export "unix_chdir") (export "caml_unix_chdir")
  (param $name (ref eq)) (result (ref eq))
  (local $p_len i32) (local $p_addr i32) (local $p_fd i32) (local $buffer i32)
  (local $res i32) (local $kind i32)
  ...
  (local.set $res
    (call $path_filestat_get (local.get $p_fd) (i32.const 1)
      (local.get $p_addr) (local.get $p_len) (local.get $buffer)))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $chdir_str)
    (local.get $name))
  (local.set $kind (i32.load8_u $m offset=16 (local.get $buffer)))
...
(@else
(func $unix_getcwd (export "unix_getcwd") (export "caml_unix_getcwd")
  (param (ref eq)) (result (ref eq))
  (try (result (ref eq))
    (do (call $caml_string_of_jsstring (call $wrap (call $getcwd))))
    (catch $javascript_exception
      (call $caml_unix_error (ref.null eq))
      (ref.i31 (i32.const 0))))
)
...
(@if $wasi
(@then (global $mkdir_str (ref $bytes) (@string "mkdir" ))

(func $unix_mkdir (export "unix_mkdir") (export "caml_unix_mkdir")
...
(global $opendir_str (ref $bytes) (@string "opendir" ))
...
(func $unix_opendir (export "unix_opendir") (export "caml_unix_opendir")
  ...
  (local.set $buffer (call $get_buffer))
  (local.set $res
    (call $path_open (local.get $p_fd) (i32.const 1) ;; symlink_follow
      (local.get $p_addr) (local.get $p_len) (i32.const 2) ;; O_DIRECTORY
      (i64.const 0x4000) ;; allow fd_readdir
      (i64.const 0) (i32.const 0) (local.get $buffer)))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $opendir_str)
    (local.get $name))
  (struct.new $directory (i32.load $m (local.get $buffer))
    (call $checked_malloc (i32.const 512)) (i32.const 512) (i32.const 0)
    (i32.const 0) (i64.const 0) (i32.const 2))
)
...
(func $is_dot_entry (param $addr i32) (param $len i32) (result i32)
  ...
  (if (i32.eq (local.get $len) (i32.const 1))
    (then
      (return (i32.eq (i32.load8_u $m (local.get $addr)) (i32.const 0x2e)))))
  (if (i32.eq (local.get $len) (i32.const 2))
    (then
      (return
        (i32.and (i32.eq (i32.load8_u $m (local.get $addr)) (i32.const 0x2e))
          (i32.eq (i32.load8_u $m offset=1 (local.get $addr))
            (i32.const 0x2e))))))
  (i32.const 0)
)
...
(func $readdir_helper (param $vdir (ref eq)) (result (ref eq))
  ...
  (local $entry i32) (local $namelen i32) (local $buf i32) (local $buffer i32)
  (local $res i32) (local $available i32)
  ...
  (block $no_dots
    (br_if $no_dots (i32.eqz (struct.get $directory $dots (local.get $dir))))
  ...
  (loop $loop
    (block $refill
      ...
      (br_if $loop
        (call $is_dot_entry (i32.add (local.get $entry) (i32.const 24))
          (local.get $namelen)))
      (return_call $blit_memory_to_string
        (i32.add (local.get $entry) (i32.const 24)) (local.get $namelen)))
    ;; refill
    (if
      ...
      (then
        ...
        (struct.set $directory $size (local.get $dir) (local.get $entry_size))
    ...
    (block $done
      ...
      (local.set $buffer (call $get_buffer))
      (local.set $res
        (call $fd_readddir (struct.get $directory $fd (local.get $dir))
          (struct.get $directory $buffer (local.get $dir))
          (struct.get $directory $size (local.get $dir))
          (struct.get $directory $cookie (local.get $dir))
          (local.get $buffer)))
      (call $caml_unix_error_if (local.get $res) (@string "readdir" )
        (global.get $no_arg))
      (local.set $available (i32.load $m (local.get $buffer)))
...
(func $unix_closedir (export "unix_closedir") (export "caml_unix_closedir")
  ...
  (block $error
    ...
    ;; Reset the read position so that a readdir on the closed
    ;; directory does not parse leftover dirents out of the freed
    ;; buffer (now address 0); instead it falls through to
  ...
  (call $caml_unix_error (local.get $res) (@string "closedir" )
    (global.get $no_arg))
  (ref.i31 (i32.const 0))
)

(func $unix_rewinddir (export "unix_rewinddir") (export "caml_unix_rewinddir")
  (param $vdir (ref eq)) (result (ref eq))
...
(func $unix_closedir (export "unix_closedir") (export "caml_unix_closedir")
  ...
  (try
    (do (call $closedir (call $unwrap (local.get $dir))))
    (catch $javascript_exception
      (drop)
...
(func $unix_readdir (export "unix_readdir") (export "caml_unix_readdir")
  (param $dir (ref eq)) (result (ref eq))
...
(func $win_findfirst (export "win_findfirst") (export "caml_unix_findfirst")
  (param $vpath (ref eq)) (result (ref eq))
  (local $p (ref $bytes)) (local $len i32) (local $p' (ref $bytes))
  (local $dir (ref eq))
  ...
  (array.copy $bytes $bytes (local.get $p') (i32.const 0) (local.get $p)
    (i32.const 0) (local.get $len))
  (local.set $dir (call $unix_opendir (local.get $p')))
  (array.new_fixed $block 3 (ref.i31 (i32.const 0))
    (call $win_find_next (local.get $dir)) (local.get $dir))
)

(@if $wasi
(@then (global $unlink_str (ref $bytes) (@string "unlink" ))

(func $unix_unlink (export "unix_unlink") (export "caml_unix_unlink")
  (param $path (ref eq)) (result (ref eq))
...
(@if $wasi
(@then (global $rmdir_str (ref $bytes) (@string "rmdir" ))

(func $unix_rmdir (export "unix_rmdir") (export "caml_unix_rmdir")
  (param $path (ref eq)) (result (ref eq))
...
(@if $wasi
(@then (global $link_str (ref $bytes) (@string "link" ))

(func $unix_link (export "unix_link") (export "caml_unix_link")
  (param $follow (ref eq)) (param $o (ref eq)) (param $n (ref eq))
  (result (ref eq))
  (local $op_len i32) (local $op_addr i32) (local $op_fd i32)
  (local $np_len i32) (local $np_addr i32) (local $np_fd i32)
  (local $flags i32) (local $arg (ref eq)) (local $res i32)
  ;; Resolve both paths without raising, so that the first buffer is
  ;; always freed below even if resolving the second path fails.
  (call $wasi_resolve_path (local.get $o))
  (local.set $op_len)
  ...
  (if (ref.test (ref $block) (local.get $follow))
    (then
      (local.set $flags
        (i31.get_u
          (ref.cast (ref i31)
            (array.get $block (ref.cast (ref $block) (local.get $follow))
              (i32.const 1)))))))
  (local.set $arg (local.get $o))
  (local.set $res (i32.const 44)) ;; ENOENT
  (block $error
    ...
    (local.set $arg (local.get $o))
    (local.set $res
      (call $path_link (local.get $op_fd) (local.get $flags)
        (local.get $op_addr) (local.get $op_len) (local.get $np_fd)
        (local.get $np_addr) (local.get $np_len))))
  (call $free (local.get $op_addr))
  (call $free (local.get $np_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $link_str)
    (local.get $arg))
  (ref.i31 (i32.const 0))
) )
(@else
...
(func $unix_has_symlink (export "unix_has_symlink")
  (export "caml_unix_has_symlink") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)

(@if $wasi
(@then (global $symlink_str (ref $bytes) (@string "symlink" ))

(func $unix_symlink (export "unix_symlink") (export "caml_unix_symlink")
  (param $to_dir (ref eq)) (param $o (ref eq)) (param $n (ref eq))
  (result (ref eq))
  (local $flags i32) (local $path (ref $bytes)) (local $len i32)
  (local $op i32) (local $np_len i32) (local $np_addr i32) (local $np_fd i32)
  (local $arg (ref eq)) (local $res i32)
  (local.set $path (ref.cast (ref $bytes) (local.get $o)))
  (local.set $len (array.len (local.get $path)))
  (local.set $op
    (call $write_string_to_memory (i32.const 0) (i32.const 0)
      (local.get $path)))
  ;; Resolve the target path without raising, so that $op is always freed
  ;; below even if resolving the second path fails.
  (call $wasi_resolve_path (local.get $n))
  (local.set $np_len)
  (local.set $np_addr)
  (local.set $np_fd)
  ...
  (block $error
    ...
    (local.set $arg (local.get $o))
    (local.set $res
      (call $path_symlink (local.get $op) (local.get $len) (local.get $np_fd)
        (local.get $np_addr) (local.get $np_len))))
  (call $free (local.get $op))
  (call $free (local.get $np_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $symlink_str)
    (local.get $arg))
  (ref.i31 (i32.const 0))
) )
(@else
    ...
    (then
      (local.set $kind
        (i32.add (i32.const 1)
          (i31.get_s
            (ref.cast (ref i31)
              (array.get $block (ref.cast (ref $block) (local.get $to_dir))
                (i32.const 1))))))))
  (try
    (do
      (call $symlink
...
(@if $wasi
(@then (global $readlink_str (ref $bytes) (@string "readlink" ))

(func $unix_readlink (export "unix_readlink") (export "caml_unix_readlink")
  (param $path (ref eq)) (result (ref eq))
  (local $p_len i32) (local $p_addr i32) (local $p_fd i32) (local $buffer i32)
  (local $buf i32) (local $res i32)
  ...
  (local.set $res
    (call $path_readlink (local.get $p_fd) (local.get $p_addr)
      (local.get $p_len) (local.get $buf) (global.get $IO_BUFFER_SIZE)
      (local.get $buffer)))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $readlink_str)
    (local.get $path))
  (return_call $blit_memory_to_string (local.get $buf)
    (i32.load $m (local.get $buffer)))
) )
(@else
(func $unix_readlink (export "unix_readlink") (export "caml_unix_readlink")
  (param $path (ref eq)) (result (ref eq))
...
(@if $wasi
(@then (global $truncate_str (ref $bytes) (@string "truncate" ))

(func $truncate_impl (param $path (ref eq)) (param $len i64) (result (ref eq))
  (local $res i32) (local $p_len i32) (local $p_addr i32) (local $p_fd i32)
  (local $buffer i32) (local $fd i32)
  (block $error
    ...
    (local.set $res
      (call $path_open (local.get $p_fd) (i32.const 1) ;; symlink_follow
        (local.get $p_addr) (local.get $p_len) (i32.const 0)
        (i64.const 0x400040) ;; allow fd_filestat_set_size and fd_write
        (i64.const 0) (i32.const 0) (local.get $buffer)))
    (call $free (local.get $p_addr))
    (br_if $error (local.get $res))
    (local.set $fd (i32.load $m (local.get $buffer)))
    (local.set $res
      (call $fd_filestat_set_size (local.get $fd) (local.get $len)))
    (if (local.get $res)
      (then (drop (call $fd_close (local.get $fd))) (br $error)))
    (local.set $res (call $fd_close (local.get $fd)))
    (br_if $error (local.get $res))
    (return (ref.i31 (i32.const 0))))
  (call $caml_unix_error (local.get $res) (global.get $truncate_str)
    (local.get $path))
  (return (ref.i31 (i32.const 0)))
)

(func $unix_truncate (export "unix_truncate") (export "caml_unix_truncate")
  (param $path (ref eq)) (param $len (ref eq)) (result (ref eq))
  (return_call $truncate_impl (local.get $path)
    (i64.extend_i32_s (i31.get_s (ref.cast (ref i31) (local.get $len)))))
)

(func $unix_truncate_64 (export "unix_truncate_64")
  (export "caml_unix_truncate_64")
  (param $path (ref eq)) (param $len (ref eq)) (result (ref eq))
  (return_call $truncate_impl (local.get $path)
...
(func $unix_truncate_64 (export "unix_truncate_64")
  (export "caml_unix_truncate_64")
  (param $path (ref eq)) (param $vlen (ref eq)) (result (ref eq))
  (local $len i64)
...
(func $ftruncate (param $vfd (ref eq)) (param $len i64) (result (ref eq))
  ...
  (local.set $res
    (call $fd_filestat_set_size (local.get $fd) (local.get $len)))
  (call $caml_unix_error_if (local.get $res) (@string "ftruncate" )
    (global.get $no_arg))
  (ref.i31 (i32.const 0))
)

(func $unix_ftruncate (export "unix_ftruncate") (export "caml_unix_ftruncate")
  (param $fd (ref eq)) (param $len (ref eq)) (result (ref eq))
  (return_call $ftruncate (local.get $fd)
    (i64.extend_i32_s (i31.get_s (ref.cast (ref i31) (local.get $len)))))
)

(func $unix_ftruncate_64 (export "unix_ftruncate_64")
  (export "caml_unix_ftruncate_64")
  (param $fd (ref eq)) (param $len (ref eq)) (result (ref eq))
  (return_call $ftruncate (local.get $fd) (call $Int64_val (local.get $len)))
) )
(@else
(func $unix_ftruncate (export "unix_ftruncate") (export "caml_unix_ftruncate")
  (param $fd (ref eq)) (param $vlen (ref eq)) (result (ref eq))
  ;; POSIX ftruncate leaves the seek pointer unchanged, even when it
  ;; ends up past the (now shorter) end of the file.
  (try
    (do (call $ftruncate (local.get $fd) (local.get $vlen)))
    (catch $javascript_exception (call $caml_unix_error (ref.null eq))))
  (ref.i31 (i32.const 0))
)
...
(@if $wasi
(@then (global $access_str (ref $bytes) (@string "access" ))

;; We can only check that the file exists
(func $unix_access (export "unix_access") (export "caml_unix_access")
  ...
  (local.set $res
    (call $path_filestat_get (local.get $p_fd) (i32.const 1)
      (local.get $p_addr) (local.get $p_len) (local.get $buffer)))
  (call $free (local.get $p_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $access_str)
    (local.get $path))
  (return (ref.i31 (i32.const 0)))
) )
(@else
(global $access_flags (ref $flags)
  (array.new_fixed $flags 4 (i32.const 1) (i32.const 2) (i32.const 4)
    (i32.const 8))
)
...
(func $unix_access (export "unix_access") (export "caml_unix_access")
  ...
  (local $flags i32)
  (local.set $flags
    (call $convert_flag_list (global.get $access_flags) (local.get $vflags)))
  (try
    (do
      (call $access
        (call $unwrap (call $caml_jsstring_of_string (local.get $path)))
...
(global $unix_open_flags (ref $flags)
  (array.new_fixed $flags 15 (i32.const 1) (i32.const 2) (i32.const 3)
    (i32.const 0x400) (i32.const 0x100) (i32.const 0x10) (i32.const 0x80)
    (i32.const 0x40) (i32.const 0) (i32.const 0x200) (i32.const 0x1000)
    (i32.const 0x800) (i32.const 0) (i32.const 0) (i32.const 0))
)

(global $open_str (ref $bytes) (@string "open" ))

(func $unix_open (export "unix_open") (export "caml_unix_open")
  (param $vpath (ref eq)) (param $vflags (ref eq)) (param $perm (ref eq))
  (result (ref eq))
  (local $offset i64) (local $path_len i32) (local $path_addr i32)
  (local $path_fd i32) (local $buffer i32) (local $flags i32) (local $res i32)
  ...
  (local.set $buffer (call $get_buffer))
  (local.set $flags
    (call $convert_flag_list (global.get $unix_open_flags)
      (local.get $vflags)))
  (local.set $res
    (call $path_open (local.get $path_fd) (i32.const 1) ;; symlink_follow
      (local.get $path_addr) (local.get $path_len)
      (i32.and (i32.shr_u (local.get $flags) (i32.const 4)) (i32.const 0xF))
      (select (i64.const 0x860007e)
      ...
      (i64.const 0) (i32.shr_u (local.get $flags) (i32.const 8))
      (local.get $buffer)))
  (call $free (local.get $path_addr))
  (call $caml_unix_error_if (local.get $res) (global.get $open_str)
    (local.get $vpath))
  (ref.i31 (i32.load $m (local.get $buffer)))
) )
(@else
;;    1 O_RDONLY
;;    2 O_WRONLY
...
;; 1024 O_SYNC
(global $unix_open_flags (ref $flags)
  (array.new_fixed $flags 15 (i32.const 1) (i32.const 2) (i32.const 4)
    (i32.const 128) (i32.const 8) (i32.const 16) (i32.const 32) (i32.const 64)
...
(@if $wasi
(@then
(func $unix_write (export "unix_write") (export "caml_unix_write")
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (result (ref eq))
  (local $fd i32) (local $s (ref $bytes)) (local $pos i32) (local $len i32)
  (local $buffer i32) (local $nwritten i32) (local $iovs i32)
  (local $iovs_len i32) (local $written i32) (local $numbytes i32)
  ...
  (i32.store $m (local.get $iovs) (local.get $buffer))
  ...
  (loop $loop
    (if (i32.gt_u (local.get $len) (i32.const 0))
      (then
        ...
        (call $blit_substring_to_memory (local.get $buffer) (local.get $s)
          (local.get $pos) (local.get $numbytes))
        (i32.store $m offset=4 (local.get $iovs) (local.get $numbytes))
        (local.set $res
          (call $fd_write (local.get $fd) (local.get $iovs)
            (local.get $iovs_len) (local.get $nwritten)))
        (call $caml_unix_error_if (local.get $res) (@string "write" )
          (global.get $no_arg))
        (local.set $n (i32.load $m (local.get $nwritten)))
...
(func $unix_single_write (export "unix_single_write")
  (export "caml_unix_single_write")
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (result (ref eq))
  (local $written i32) (local $n i32) (local $fd i32) (local $s (ref $bytes))
  (local $pos i32) (local $len i32) (local $buffer i32) (local $nwritten i32)
  (local $iovs i32) (local $iovs_len i32) (local $numbytes i32)
  (local $res i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $s (ref.cast (ref $bytes) (local.get $vbuf)))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
  (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
  (if (i32.eqz (local.get $len)) (then (return (ref.i31 (i32.const 0)))))
  (local.set $buffer (call $get_buffer))
  (local.set $nwritten (local.get $buffer))
  (local.set $iovs (i32.add (local.get $buffer) (i32.const 4)))
  (local.set $buffer (i32.add (local.get $buffer) (i32.const 12)))
  ...
  (i32.store $m offset=4 (local.get $iovs) (local.get $numbytes))
  (local.set $res
    (call $fd_write (local.get $fd) (local.get $iovs) (local.get $iovs_len)
      (local.get $nwritten)))
  (call $caml_unix_error_if (local.get $res) (@string "write" )
    (global.get $no_arg))
  (ref.i31 (i32.load $m (local.get $nwritten)))
)

(func $unix_read (export "unix_read") (export "caml_unix_read")
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (result (ref eq))
  (local $fd i32) (local $pos i32) (local $len i32) (local $buffer i32)
  (local $nread i32) (local $iovs i32) (local $iovs_len i32) (local $res i32)
  (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
  (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
  (if (i32.gt_u (local.get $len) (global.get $IO_BUFFER_SIZE))
    (then (local.set $len (global.get $IO_BUFFER_SIZE))))
  (local.set $buffer (call $get_buffer))
  (local.set $nread (local.get $buffer))
  (local.set $iovs (i32.add (local.get $buffer) (i32.const 4)))
  (local.set $buffer (i32.add (local.get $buffer) (i32.const 12)))
  (i32.store $m (local.get $iovs) (local.get $buffer))
  (i32.store $m offset=4 (local.get $iovs) (local.get $len))
  (local.set $iovs_len (i32.const 1))
  (local.set $res
    (call $fd_read (local.get $fd) (local.get $iovs) (local.get $iovs_len)
      (local.get $nread)))
  (call $caml_unix_error_if (local.get $res) (@string "read" )
    (global.get $no_arg))
  (local.set $n (i32.load $m (local.get $nread)))
  (call $blit_memory_to_substring (local.get $buffer)
    (ref.cast (ref $bytes) (local.get $vbuf)) (local.get $pos) (local.get $n))
  (ref.i31 (local.get $n))
)

(type $dat
  (struct (field $array (ref array)) (field $offset i32) (field $len i32))
)

(func $unix_write_bigarray (export "unix_write_bigarray")
  (export "caml_unix_write_bigarray")
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (param $vsingle (ref eq)) (result (ref eq))
  (local $fd i32) (local $dat (ref $dat)) (local $buf (ref $bytes))
  (local $pos i32) (local $len i32) (local $buffer i32) (local $nwritten i32)
  (local $iovs i32) (local $iovs_len i32) (local $written i32)
  (local $numbytes i32) (local $res i32) (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $dat
    (ref.cast (ref $dat)
    ...
    (if (i32.gt_u (local.get $len) (i32.const 0))
      (then
        (local.set $numbytes
          (select (global.get $IO_BUFFER_SIZE) (local.get $len)
            (i32.gt_u (local.get $len) (global.get $IO_BUFFER_SIZE))))
        (call $blit_substring_to_memory (local.get $buffer) (local.get $buf)
          (local.get $pos) (local.get $numbytes))
        (i32.store $m offset=4 (local.get $iovs) (local.get $numbytes))
        (local.set $res
          (call $fd_write (local.get $fd) (local.get $iovs)
        ...
        (local.set $pos (i32.add (local.get $pos) (local.get $n)))
        (local.set $len (i32.sub (local.get $len) (local.get $n)))
        (br_if $loop (ref.eq (local.get $vsingle) (ref.i31 (i32.const 0)))))))
  (ref.i31 (local.get $written))
)

(func $unix_read_bigarray (export "unix_read_bigarray")
  (export "caml_unix_read_bigarray")
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (result (ref eq))
  (local $fd i32) (local $dat (ref $dat)) (local $buf (ref $bytes))
  (local $pos i32) (local $len i32) (local $buffer i32) (local $nread i32)
  (local $iovs i32) (local $iovs_len i32) (local $res i32) (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $dat
    (ref.cast (ref $dat)
      (any.convert_extern (call $caml_ba_get_data (local.get $vbuf)))))
  ...
  (call $caml_unix_error_if (local.get $res) (@string "read" )
    (global.get $no_arg))
  (local.set $n (i32.load $m (local.get $nread)))
  (call $blit_memory_to_substring (local.get $buffer) (local.get $buf)
...
(func $unix_write (export "unix_write") (export "caml_unix_write")
  ...
  (local $fd_offset (ref $fd_offset)) (local $offset i64) (local $written i32)
  (local $numbytes i32) (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $s (ref.cast (ref $bytes) (local.get $vbuf)))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
  (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
    ...
    (if (i32.gt_u (local.get $len) (i32.const 0))
      (then
        (local.set $numbytes
          (select (global.get $IO_BUFFER_SIZE) (local.get $len)
            (i32.gt_u (local.get $len) (global.get $IO_BUFFER_SIZE))))
        (call $caml_blit_bytes_to_dataview (local.get $s) (local.get $pos)
              ...
              (if (result i32)
                ...
                (then
                  (call $write (local.get $fd) (local.get $buf) (i32.const 0)
                    (local.get $numbytes) (local.get $offset)))
                (else
                  (call $write' (local.get $fd) (local.get $buf) (i32.const 0)
                    (local.get $numbytes) (ref.null noextern))))))
          (catch $javascript_exception (call $caml_unix_error (ref.null eq))))
        (local.set $offset
...
(func $unix_single_write (export "unix_single_write")
  ...
  (local $fd i32) (local $s (ref $bytes)) (local $pos i32) (local $len i32)
  (local $buf (ref extern)) (local $buf_view (ref extern))
  (local $fd_offset (ref $fd_offset)) (local $offset i64) (local $n i32)
  (local $numbytes i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $s (ref.cast (ref $bytes) (local.get $vbuf)))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
...
(func $unix_read (export "unix_read") (export "caml_unix_read")
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (result (ref eq))
  (local $fd i32) (local $pos i32) (local $len i32) (local $buf (ref extern))
  (local $buf_view (ref extern)) (local $fd_offset (ref $fd_offset))
  (local $offset i64) (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
  (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
  (if (i32.gt_u (local.get $len) (global.get $IO_BUFFER_SIZE))
    ...
    (do
      (local.set $n
        (if (result i32)
          (struct.get $fd_offset $seeked (local.get $fd_offset))
          (then
            (call $read (local.get $fd) (local.get $buf) (i32.const 0)
  ...
  (call $caml_blit_dataview_to_bytes (local.get $buf_view) (i32.const 0)
    (ref.cast (ref $bytes) (local.get $vbuf)) (local.get $pos) (local.get $n))
  (ref.i31 (local.get $n))
)
...
(func $unix_write_bigarray (export "unix_write_bigarray")
  ...
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (param $vsingle (ref eq)) (result (ref eq))
  (local $fd i32) (local $buf (ref extern)) (local $pos i32) (local $len i32)
  (local $fd_offset (ref $fd_offset)) (local $offset i64) (local $written i32)
  (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
    ...
    (do
      (local.set $n
        (if (result i32)
          (struct.get $fd_offset $seeked (local.get $fd_offset))
          (then
            (call $read (local.get $fd) (local.get $buf) (local.get $pos)
              (local.get $len) (local.get $offset)))
          (else
            (call $read' (local.get $fd) (local.get $buf) (local.get $pos)
              (local.get $len) (ref.null noextern))))))
...
(@then
(func $lseek
  (param $fd (ref eq)) (param $offset i64) (param $cmd (ref eq)) (result i64)
  (local $buffer i32) (local $res i32)
  (local.set $buffer (call $get_buffer))
  (local.set $res
    (call $fd_seek (i31.get_u (ref.cast (ref i31) (local.get $fd)))
      (local.get $offset) (i31.get_u (ref.cast (ref i31) (local.get $cmd)))
      (local.get $buffer)))
  (call $caml_unix_error_if (local.get $res) (@string "lseek" )
    (global.get $no_arg))
  (i64.load $m (local.get $buffer))
) )
(@else
(func $lseek_exn (param $errno i32) (result (ref eq))
  (array.new_fixed $block 5 (ref.i31 (i32.const 0)) (call $get_unix_error_exn)
    (ref.i31 (local.get $errno)) (@string "lseek" ) (global.get $no_arg))
)

(func $lseek
  (param $vfd (ref eq)) (param $offset i64) (param $cmd (ref eq)) (result i64)
    ...
    (then
      (local.set $offset
        (i64.add (struct.get $fd_offset $offset (local.get $fd_offset))
          (local.get $offset))))
    (else
      (if (ref.eq (local.get $cmd) (ref.i31 (i32.const 2)))
        (then
          (local.set $offset
  ...
  (if (i64.lt_s (local.get $offset) (i64.const 0))
    (then
      (throw $ocaml_exception (call $lseek_exn (i32.const 12))))) ;; EINVAL
  (struct.set $fd_offset $offset (local.get $fd_offset) (local.get $offset))
  (struct.set $fd_offset $seeked (local.get $fd_offset) (i32.const 1))
  (local.get $offset)
) ) )

(func $unix_lseek (export "unix_lseek") (export "caml_unix_lseek")
  (param $fd (ref eq)) (param $ofs (ref eq)) (param $cmd (ref eq))
  (result (ref eq))
  (ref.i31
    (i32.wrap_i64
      (call $lseek (local.get $fd)
        (i64.extend_i32_s (i31.get_s (ref.cast (ref i31) (local.get $ofs))))
        (local.get $cmd))))
)

(func $unix_lseek_64 (export "unix_lseek_64") (export "caml_unix_lseek_64")
  (param $fd (ref eq)) (param $ofs (ref eq)) (param $cmd (ref eq))
  (result (ref eq))
  (return_call $caml_copy_int64
    (call $lseek (local.get $fd) (call $Int64_val (local.get $ofs))
      (local.get $cmd)))
)

(@if $wasi
(@then
(func $unix_fsync (export "unix_fsync") (export "caml_unix_fsync")
  (param $fd (ref eq)) (result (ref eq))
  (local $res i32)
  (local.set $res
    (call $fd_sync (i31.get_u (ref.cast (ref i31) (local.get $fd)))))
  (call $caml_unix_error_if (local.get $res) (@string "fsync" )
    (global.get $no_arg))
  (ref.i31 (i32.const 0))
) )
(@else
(func $unix_fsync (export "unix_fsync") (export "caml_unix_fsync")
  (param $fd (ref eq)) (result (ref eq))
  (try
    (do (call $fsync (local.get $fd)))
    (catch $javascript_exception (call $caml_unix_error (ref.null eq))))
  (ref.i31 (i32.const 0))
) ) )

(global $out_channel_of_descr (ref $bytes) (@string "out_channel_of_descr" ))
(global $in_channel_of_descr (ref $bytes) (@string "in_channel_of_descr" ))

(func $channel_of_descr_name (param $out i32) (result (ref eq))
  (select (result (ref $bytes)) (global.get $out_channel_of_descr)
    (global.get $in_channel_of_descr) (local.get $out))
)

(@if $wasi
(@then
(func $caml_unix_check_stream_semantics (param $fd (ref eq)) (param $out i32)
  (local $s (ref $block)) (local $file_type i32) (local $buffer i32)
  (local $res i32) (local $kind i32)
  (local.set $buffer (call $get_buffer))
  (local.set $res
    (call $fd_filestat_get (i31.get_u (ref.cast (ref i31) (local.get $fd)))
      (local.get $buffer)))
  (call $caml_unix_error_if (local.get $res)
    (call $channel_of_descr_name (local.get $out)) (global.get $no_arg))
  (local.set $kind (i32.load8_u $m offset=16 (local.get $buffer)))
  (block $ok
    (block $bad
...
(func $caml_unix_check_stream_semantics (param $fd (ref eq)) (param $out i32)
  ...
  (local.set $kind
    (i31.get_u
      (ref.cast (ref i31) (array.get $block (local.get $s) (i32.const 3)))))
  (block $ok
...
(func $unix_inchannel_of_filedescr (export "unix_inchannel_of_filedescr")
...
(func $unix_outchannel_of_filedescr (export "unix_outchannel_of_filedescr")
...
(@if $wasi
(@then
(func $unix_close (export "unix_close") (export "caml_unix_close")
  (param $fd (ref eq)) (result (ref eq))
  (local $res i32)
  (local.set $res
    (call $fd_close (i31.get_u (ref.cast (ref i31) (local.get $fd)))))
  (call $caml_unix_error_if (local.get $res) (@string "close" )
    (global.get $no_arg))
  (ref.i31 (i32.const 0))
) )
(@else
...
(func $unix_getuid (export "unix_getuid") (export "caml_unix_getuid")
  (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)
(func $unix_geteuid (export "unix_geteuid") (export "caml_unix_geteuid")
  (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)
(func $unix_getgid (export "unix_getgid") (export "caml_unix_getgid")
  (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)
(func $unix_getegid (export "unix_getegid") (export "caml_unix_getegid")
  (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
) )
(@else
...
(func $unix_getpwnam (export "unix_getpwnam") (export "caml_unix_getpwnam")
  (export "unix_getpwuid") (export "caml_unix_getpwuid")
  (export "unix_getgrnam") (export "caml_unix_getgrnam")
  (export "unix_getgrgid") (export "caml_unix_getgrgid")
  (param (ref eq)) (result (ref eq))
...
(func $win_handle_fd (export "win_handle_fd")
  (export "caml_unix_filedescr_of_fd") (param $v (ref eq)) (result (ref eq))
  (local.get $v)
)

(func $win_cleanup (export "win_cleanup") (export "caml_unix_cleanup")
  (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)
