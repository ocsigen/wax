...
(func $caml_lex_engine (export "caml_lex_engine")
  ...
  (local $buffer (ref $string)) (local $vpos (ref eq))
  (local $lex_base_2 (ref $string)) (local $lex_backtrk_2 (ref $string))
  ...
  (local $base i32) (local $backtrk i32) (local $c i32) (local $pos i32)
  (local $action (ref eq))
...
(func $caml_new_lex_engine (export "caml_new_lex_engine")
  ...
  (local $tbl (ref $block)) (local $lexbuf (ref $block)) (local $state i32)
  (local $buffer (ref $string)) (local $vpos (ref eq))
  (local $lex_code_2 (ref $string)) (local $lex_base_2 (ref $string))
  (local $lex_base_code_2 (ref $string)) (local $lex_backtrk_2 (ref $string))
  (local $lex_backtrk_code_2 (ref $string)) (local $lex_check_2 (ref $string))
  (local $lex_check_code_2 (ref $string)) (local $lex_trans_2 (ref $string))
  (local $lex_trans_code_2 (ref $string)) (local $lex_default_2 (ref $string))
  (local $lex_default_code_2 (ref $string)) (local $base i32)
  (local $pc_off i32) (local $backtrk i32) (local $c i32) (local $pos i32)
