...
(import "float" "caml_parse_float"
  (func $caml_parse_float (param (ref eq) (ref eq)) (result (ref eq)))
)
(import "float" "caml_format_float"
  (func $caml_format_float (param (ref eq) (ref eq)) (result (ref eq)))
)
(import "float" "caml_fma_float"
  (func $caml_fma_float (param (ref eq) (ref eq) (ref eq)) (result (ref eq)))
)
...
(import "float" "caml_ldexp_float"
  (func $caml_ldexp_float (param f64 i32) (result f64))
)
(import "bigarray" "caml_ba_uint8_get32"
  (func $caml_ba_uint8_get32 (param (ref eq) i32) (result i32))
)
(import "bigarray" "caml_ba_uint8_get32u"
  (func $caml_ba_uint8_get32u (param (ref eq) i32) (result i32))
)
(import "bigarray" "caml_ba_uint8_set32"
  (func $caml_ba_uint8_set32 (param (ref eq) i32 i32) (result (ref eq)))
)
(import "bigarray" "caml_ba_uint8_set32u"
  (func $caml_ba_uint8_set32u (param (ref eq) i32 i32) (result (ref eq)))
)
(import "string" "caml_string_get32"
  (func $caml_string_get32 (param (ref eq) i32) (result i32))
)
(import "string" "caml_string_get32u"
  (func $caml_string_get32u (param (ref eq) i32) (result i32))
)
(import "string" "caml_bytes_get32"
  (func $caml_bytes_get32 (param (ref eq) i32) (result i32))
)
(import "string" "caml_bytes_get32u"
  (func $caml_bytes_get32u (param (ref eq) i32) (result i32))
)
(import "string" "caml_bytes_set32"
  (func $caml_bytes_set32 (param (ref eq) i32 i32) (result (ref eq)))
)
(import "string" "caml_bytes_set32u"
  (func $caml_bytes_set32u (param (ref eq) i32 i32) (result (ref eq)))
)
...
(func $unbox_float (param $f (ref eq)) (result f64)
  (struct.get $float $f (ref.cast (ref $float) (local.get $f)))
)
...
(type $float32
  (sub final $custom
    (struct (field $ops (ref $custom_operations)) (field $f32 f32)))
)
...
(func $unbox_float32 (param $f (ref eq)) (result f32)
  (struct.get $float32 $f32 (ref.cast (ref $float32) (local.get $f)))
)
...
(func $float32_hash (param $v (ref eq)) (result i32)
  ...
  (if
    ...
    (then
      (if (i32.ne (i32.and (local.get $i) (i32.const 0x7FFFFF)) (i32.const 0))
...
(func $float32_dup (param $v (ref eq)) (result (ref eq))
  (local $d (ref $float32))
  (local.set $d (ref.cast (ref $float32) (local.get $v)))
  (struct.new $float32 (struct.get $float32 $ops (local.get $d))
    (struct.get $float32 $f32 (local.get $d)))
)

(func $caml_float_of_float32 (param $f32 (ref eq)) (result (ref eq))
  (call $box_float (f64.promote_f32 (call $unbox_float32 (local.get $f32))))
)

(func $caml_float32_of_float (param $f64 (ref eq)) (result (ref eq))
  (call $box_float32 (f32.demote_f64 (call $unbox_float (local.get $f64))))
)

(func $caml_round_float32_bytecode (export "caml_round_float32_bytecode")
  (param $x f32) (result f32)
  (local $y f32)
  (if (result f32) (f32.ge (local.get $x) (f32.const 0))
    (then
      (local.set $y (f32.floor (local.get $x)))
      (if (result f32)
        (f32.ge (f32.sub (local.get $x) (local.get $y)) (f32.const 0.5))
        (then (f32.add (local.get $y) (f32.const 1)))
        (else (local.get $y))))
    (else
      (local.set $y (f32.ceil (local.get $x)))
      (if (result f32)
        (f32.ge (f32.sub (local.get $y) (local.get $x)) (f32.const 0.5))
        (then (f32.sub (local.get $y) (f32.const 1)))
        (else (local.get $y)))))
)
...
(func $caml_float32_of_string (export "caml_float32_of_string")
  ...
  (call $caml_float32_of_float
    (call $caml_parse_float (global.get $float32_of_string) (local.get $s)))
)

(func $caml_format_float32 (export "caml_format_float32")
  (param $s (ref eq)) (param $f (ref eq)) (result (ref eq))
  (call $caml_format_float (local.get $s)
    (call $caml_float_of_float32 (local.get $f)))
)

(func $caml_float32_compare (export "caml_float32_compare")
...
(func $caml_modf_float32 (export "caml_modf_float32")
...
(func $caml_nextafter_float32_bytecode
  ...
  (if (f32.eq (local.get $x) (local.get $y)) (then (return (local.get $y))))
  (if (result f32) (f32.eq (local.get $x) (f32.const 0))
    ...
    (else
      ...
      (if
        (i32.and (i32.lt_s (local.get $i) (local.get $j))
          (i32.lt_u (local.get $i) (local.get $j)))
        (then (local.set $i (i32.add (local.get $i) (i32.const 1))))
        (else (local.set $i (i32.sub (local.get $i) (i32.const 1)))))
      (return (f32.reinterpret_i32 (local.get $i)))))
)

(func $caml_classify_float32_bytecode
  (export "caml_classify_float32_bytecode") (param $a f32) (result i32)
  (local.set $a (f32.abs (local.get $a)))
...
(func $caml_ldexp_float32_bytecode (export "caml_ldexp_float32_bytecode")
  (param $x f32) (param $n i32) (result f32)
  (f32.demote_f64
    (call $caml_ldexp_float (f64.promote_f32 (local.get $x)) (local.get $n)))
)

(func $caml_frexp_float32 (export "caml_frexp_float32")
...
(func $caml_erf_float32_bytecode (export "caml_erf_float32_bytecode")
  (param $x f32) (result f32)
  (f32.demote_f64 (call $caml_erf_float (f64.promote_f32 (local.get $x))))
)

(func $caml_erfc_float32_bytecode (export "caml_erfc_float32_bytecode")
  (param $x f32) (result f32)
  (f32.demote_f64 (call $caml_erfc_float (f64.promote_f32 (local.get $x))))
)

(func $caml_fma_float32_bytecode (export "caml_fma_float32_bytecode")
  (param $x (ref eq)) (param $y (ref eq)) (param $z (ref eq))
  (result (ref eq))
  (call $caml_float32_of_float
    (call $caml_fma_float (call $caml_float_of_float32 (local.get $x))
      (call $caml_float_of_float32 (local.get $y))
      (call $caml_float_of_float32 (local.get $z))))
)

(func $caml_ba_uint8_getf32 (export "caml_ba_uint8_getf32")
  (param $a (ref eq)) (param $i i32) (result f32)
  (f32.reinterpret_i32
    (call $caml_ba_uint8_get32 (local.get $a) (local.get $i)))
)

(func $caml_ba_uint8_getf32u (export "caml_ba_uint8_getf32u")
  (param $a (ref eq)) (param $i i32) (result f32)
  (f32.reinterpret_i32
    (call $caml_ba_uint8_get32u (local.get $a) (local.get $i)))
)

(func $caml_ba_uint8_setf32 (export "caml_ba_uint8_setf32")
...
(func $caml_ba_uint8_setf32u (export "caml_ba_uint8_setf32u")
  (param $a (ref eq)) (param $i i32) (param $v f32) (result (ref eq))
  (call $caml_ba_uint8_set32u (local.get $a) (local.get $i)
    (i32.reinterpret_f32 (local.get $v)))
)

(func $caml_string_getf32 (export "caml_string_getf32")
  (param $a (ref eq)) (param $i i32) (result f32)
  (f32.reinterpret_i32
    (call $caml_string_get32 (local.get $a) (local.get $i)))
)

(func $caml_string_getf32u (export "caml_string_getf32u")
  (param $a (ref eq)) (param $i i32) (result f32)
  (f32.reinterpret_i32
    (call $caml_string_get32u (local.get $a) (local.get $i)))
)

(func $caml_bytes_getf32 (export "caml_bytes_getf32")
  (param $a (ref eq)) (param $i i32) (result f32)
  (f32.reinterpret_i32 (call $caml_bytes_get32 (local.get $a) (local.get $i)))
)

(func $caml_bytes_getf32u (export "caml_bytes_getf32u")
  (param $a (ref eq)) (param $i i32) (result f32)
  (f32.reinterpret_i32
    (call $caml_bytes_get32u (local.get $a) (local.get $i)))
)

(func $caml_bytes_setf32 (export "caml_bytes_setf32")
  (param $a (ref eq)) (param $i i32) (param $v f32) (result (ref eq))
...
(func $caml_simd_float32_min_bytecode
...
(func $caml_simd_float32_max_bytecode
...
(func $caml_bytes_setf32u (export "caml_bytes_setf32u")
  (param $a (ref eq)) (param $i i32) (param $v f32) (result (ref eq))
