...
(func $caml_string_equal (export "caml_string_equal")
  ...
  (local $s1 (ref $bytes)) (local $s2 (ref $bytes)) (local $len i32)
  (local $i i32)
  ...
  (loop $loop
    (if (i32.lt_s (local.get $i) (local.get $len))
      (then
        (if
          (i32.ne (array.get_u $bytes (local.get $s1) (local.get $i))
...
(func $string_compare (param $p1 (ref eq)) (param $p2 (ref eq)) (result i32)
  (local $s1 (ref $bytes)) (local $s2 (ref $bytes)) (local $l1 i32)
  ...
  (loop $loop
    (if (i32.lt_s (local.get $i) (local.get $len))
      (then
        (local.set $c1 (array.get_u $bytes (local.get $s1) (local.get $i)))
        (local.set $c2 (array.get_u $bytes (local.get $s2) (local.get $i)))
...
(func $caml_string_compare (export "caml_string_compare")
  ...
  (ref.i31 (call $string_compare (local.get $v1) (local.get $v2)))
)
...
(func $caml_string_lessequal (export "caml_string_lessequal")
  ...
  (param $v1 (ref eq)) (param $v2 (ref eq)) (result (ref eq))
  (ref.i31
    (i32.le_s (call $string_compare (local.get $v1) (local.get $v2))
      (i32.const 0)))
)
...
(func $caml_string_lessthan (export "caml_string_lessthan")
  ...
  (param $v1 (ref eq)) (param $v2 (ref eq)) (result (ref eq))
  (ref.i31
    (i32.lt_s (call $string_compare (local.get $v1) (local.get $v2))
      (i32.const 0)))
)
...
(func $caml_string_greaterequal (export "caml_string_greaterequal")
  ...
  (param $v1 (ref eq)) (param $v2 (ref eq)) (result (ref eq))
  (ref.i31
    (i32.ge_s (call $string_compare (local.get $v1) (local.get $v2))
      (i32.const 0)))
)
...
(func $caml_string_greaterthan (export "caml_string_greaterthan")
  ...
  (param $v1 (ref eq)) (param $v2 (ref eq)) (result (ref eq))
  (ref.i31
    (i32.gt_s (call $string_compare (local.get $v1) (local.get $v2))
      (i32.const 0)))
)
...
(func $caml_blit_string (export "caml_blit_string") (export "caml_blit_bytes")
  (param $v1 (ref eq)) (param $i1 (ref eq)) (param $v2 (ref eq))
  (param $i2 (ref eq)) (param $n (ref eq)) (result (ref eq))
  (array.copy $bytes $bytes (ref.cast (ref $bytes) (local.get $v2))
...
(func $caml_bytes_get16 (export "caml_bytes_get16")
  (export "caml_string_get16") (param $v (ref eq)) (param $p i32) (result i32)
  (local $s (ref $bytes))
  ...
  (i32.or (array.get_u $bytes (local.get $s) (local.get $p))
    (i32.shl
      (array.get_u $bytes (local.get $s)
        (i32.add (local.get $p) (i32.const 1))) (i32.const 8)))
)

(func $caml_bytes_get16u (export "caml_bytes_get16u")
  (export "caml_string_get16u")
...
(func $caml_bytes_get32 (export "caml_bytes_get32")
  (export "caml_string_get32") (param $v (ref eq)) (param $p i32) (result i32)
  (local $s (ref $bytes))
  (local.set $s (ref.cast (ref $bytes) (local.get $v)))
  (if (i32.lt_s (local.get $p) (i32.const 0)) (then (call $caml_bound_error)))
  (if
...
(func $caml_bytes_get32u (export "caml_bytes_get32u")
  (export "caml_string_get32u")
  (param $v (ref eq)) (param $p i32) (result i32)
  (local $s (ref $bytes))
  (local.set $s (ref.cast (ref $bytes) (local.get $v)))
  (i32.or
...
(func $caml_bytes_get64 (export "caml_bytes_get64")
  (export "caml_string_get64") (param $v (ref eq)) (param $p i32) (result i64)
  (local $s (ref $bytes))
  (local.set $s (ref.cast (ref $bytes) (local.get $v)))
  (if (i32.lt_s (local.get $p) (i32.const 0)) (then (call $caml_bound_error)))
  (if
  ...
  (i64.or
    (i64.or
      (i64.or
        (i64.extend_i32_u (array.get_u $bytes (local.get $s) (local.get $p)))
        (i64.shl
          (i64.extend_i32_u
            (array.get_u $bytes (local.get $s)
              (i32.add (local.get $p) (i32.const 1)))) (i64.const 8)))
      (i64.or
        (i64.shl
          (i64.extend_i32_u
            (array.get_u $bytes (local.get $s)
              (i32.add (local.get $p) (i32.const 2)))) (i64.const 16))
        (i64.shl
          (i64.extend_i32_u
            (array.get_u $bytes (local.get $s)
              (i32.add (local.get $p) (i32.const 3)))) (i64.const 24))))
    (i64.or
      (i64.or
        (i64.shl
          (i64.extend_i32_u
        ...
        (i64.shl
          (i64.extend_i32_u
            (array.get_u $bytes (local.get $s)
              (i32.add (local.get $p) (i32.const 5)))) (i64.const 40)))
      (i64.or
        (i64.shl
          (i64.extend_i32_u
            (array.get_u $bytes (local.get $s)
              (i32.add (local.get $p) (i32.const 6)))) (i64.const 48))
        (i64.shl
          (i64.extend_i32_u
            (array.get_u $bytes (local.get $s)
              (i32.add (local.get $p) (i32.const 7)))) (i64.const 56)))))
)

(func $caml_bytes_get64u (export "caml_bytes_get64u")
  (export "caml_string_get64u")
...
(func $caml_bytes_set16 (export "caml_bytes_set16")
  ...
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 1))
    (i32.shr_u (local.get $v) (i32.const 8)))
  (ref.i31 (i32.const 0))
)

(func $caml_bytes_set16u (export "caml_bytes_set16u")
  (param $vs (ref eq)) (param $p i32) (param $v i32) (result (ref eq))
  (local $s (ref $bytes))
  (local.set $s (ref.cast (ref $bytes) (local.get $vs)))
  (array.set $bytes (local.get $s) (local.get $p) (local.get $v))
...
(func $caml_bytes_set32 (export "caml_bytes_set32")
  ...
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 1))
    (i32.shr_u (local.get $v) (i32.const 8)))
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 2))
    (i32.shr_u (local.get $v) (i32.const 16)))
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 3))
    (i32.shr_u (local.get $v) (i32.const 24)))
  (ref.i31 (i32.const 0))
)

(func $caml_bytes_set32u (export "caml_bytes_set32u")
  (param $vs (ref eq)) (param $p i32) (param $v i32) (result (ref eq))
  (local $s (ref $bytes))
  (local.set $s (ref.cast (ref $bytes) (local.get $vs)))
  (array.set $bytes (local.get $s) (local.get $p) (local.get $v))
...
(func $caml_bytes_set64 (export "caml_bytes_set64")
  ...
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 4))
    (i32.wrap_i64 (i64.shr_u (local.get $v) (i64.const 32))))
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 5))
    (i32.wrap_i64 (i64.shr_u (local.get $v) (i64.const 40))))
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 6))
    (i32.wrap_i64 (i64.shr_u (local.get $v) (i64.const 48))))
  (array.set $bytes (local.get $s) (i32.add (local.get $p) (i32.const 7))
    (i32.wrap_i64 (i64.shr_u (local.get $v) (i64.const 56))))
  (ref.i31 (i32.const 0))
)

(func $caml_bytes_set64u (export "caml_bytes_set64u")
  (param $vs (ref eq)) (param $p i32) (param $v i64) (result (ref eq))
  (local $s (ref $bytes))
  (local.set $s (ref.cast (ref $bytes) (local.get $vs)))
  (array.set $bytes (local.get $s) (local.get $p)
...
(func $caml_string_concat (export "caml_string_concat")
  ...
  (local $s1 (ref $bytes)) (local $s2 (ref $bytes)) (local $l1 i32)
  (local $l2 i32) (local $s (ref $bytes))
  ...
  (array.copy $bytes $bytes (local.get $s) (i32.const 0) (local.get $s1)
    (i32.const 0) (local.get $l1))
  (array.copy $bytes $bytes (local.get $s) (local.get $l1) (local.get $s2)
