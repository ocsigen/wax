  ...
  (block $default
    (local.set $a1
      (block $arm (result (ref $block))
        (drop (br_on_cast $arm (ref eq) (ref $block) (local.get $a)))
        (br $default)))
    (local.set $a2
...
(func $caml_floatarray_dup (param $a (ref $float_array)) (result (ref eq))
  (local $len i32) (local $a' (ref $float_array))
...
(func $caml_array_append (export "caml_array_append")
  ...
  (block $default
    (local.set $a1
      (block $arm (result (ref $block))
        (drop (br_on_cast $arm (ref eq) (ref $block) (local.get $va1)))
        (br $default)))
    (block $default1
      (local.set $a2
        (block $arm (result (ref $block))
          (drop (br_on_cast $arm (ref eq) (ref $block) (local.get $va2)))
          (br $default1)))
      ...
      (array.copy $block $block (local.get $a) (i32.const 1) (local.get $a1)
        (i32.const 1) (i32.sub (local.get $l1) (i32.const 1)))
      (array.copy $block $block (local.get $a) (local.get $l1) (local.get $a2)
        (i32.const 1) (i32.sub (local.get $l2) (i32.const 1)))
      (return (local.get $a)))
  ...
  (block $default
    (local.set $fa2
      (block $arm (result (ref $float_array))
        (drop (br_on_cast $arm (ref eq) (ref $float_array) (local.get $va2)))
        (br $default)))
