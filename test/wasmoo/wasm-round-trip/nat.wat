...
(type $nat
  (sub final $custom
    (struct (field $f (ref $custom_operations)) (field $dat (ref $digits))))
)
...
(func $div_helper
  ...
  (local $c64 i64) (local $x i64) (local $y i64) (local $z i64) (local $w i64)
  (local.set $c64 (i64.extend_i32_u (local.get $c)))
  ;; x = a*65536 + (b >>> 16)
  (local.set $x
    (i64.add (i64.mul (i64.extend_i32_u (local.get $a)) (i64.const 65536))
  ...
  ;; quotient, remainder
  (i32.wrap_i64
    (i64.add (local.get $y) (i64.div_u (local.get $w) (local.get $c64))))
...
(func $serialize_nat (param $s (ref eq)) (param $v (ref eq)) (result i32 i32)
...
(func $deserialize_nat (param $s (ref eq)) (result (ref eq) i32)
  (local $len i32) (local $dat (ref $digits)) (local $i i32)
...
(func $length_nat (export "length_nat")
  (param $nat (ref eq)) (result (ref eq))
...
(func $blit_nat (export "blit_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $nat2 (ref eq))
  (param $ofs2 (ref eq)) (param $len (ref eq)) (result (ref eq))
  (array.copy $digits $digits (call $get_data (local.get $nat1))
    (call $int (local.get $ofs1)) (call $get_data (local.get $nat2))
    (call $int (local.get $ofs2)) (call $int (local.get $len)))
  (ref.i31 (i32.const 0))
)
...
(func $nth_digit_nat (export "nth_digit_nat")
...
(func $set_digit_nat_native (export "set_digit_nat_native")
  (param $nat (ref eq)) (param $ofs (ref eq)) (param $digit (ref eq))
  (result (ref eq))
  (array.set $digits (call $get_data (local.get $nat))
...
(func $nth_digit_nat_native (export "nth_digit_nat_native")
  (param $nat (ref eq)) (param $ofs (ref eq)) (result (ref eq))
...
(func $num_digits_nat (export "num_digits_nat")
  (param $nat (ref eq)) (param $ofs (ref eq)) (param $len (ref eq))
  (result (ref eq))
  (ref.i31
...
(func $num_leading_zero_bits_in_digit
...
(func $is_digit_int (export "is_digit_int")
  (param $nat (ref eq)) (param $ofs (ref eq)) (result (ref eq))
  ...
  (ref.i31
    (i32.lt_u
      (array.get $digits (call $get_data (local.get $nat))
        (call $int (local.get $ofs))) (i32.const 0x40000000)))
)

(func $is_digit_zero (export "is_digit_zero")
  (param $nat (ref eq)) (param $ofs (ref eq)) (result (ref eq))
  (ref.i31
    (i32.eqz
      (array.get $digits (call $get_data (local.get $nat))
...
(func $is_digit_normalized (export "is_digit_normalized")
  (param $nat (ref eq)) (param $ofs (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)

(func $is_digit_odd (export "is_digit_odd")
  (param $nat (ref eq)) (param $ofs (ref eq)) (result (ref eq))
  (ref.i31
    (i32.and
      (array.get $digits (call $get_data (local.get $nat))
        (call $int (local.get $ofs))) (i32.const 1)))
)

(func $incr
  (param $d (ref $digits)) (param $ofs i32) (param $len i32)
  (param $carry i32) (result i32)
  (local $i i32) (local $idx i32) (local $x i64)
  (loop $loop
    (if (i32.lt_s (local.get $i) (local.get $len))
      (then
...
(func $add_nat (export "add_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $len2 (ref eq))
  (param $carry (ref eq)) (result (ref eq))
  (ref.i31
    (call $add (call $get_data (local.get $nat1))
      (call $int (local.get $ofs1)) (call $int (local.get $len1))
      (call $get_data (local.get $nat2)) (call $int (local.get $ofs2))
      (call $int (local.get $len2)) (call $int (local.get $carry))))
)

(func $complement_nat (export "complement_nat")
  (param $nat (ref eq)) (param $ofs (ref eq)) (param $len (ref eq))
  (result (ref eq))
  (local $d (ref $digits)) (local $o i32) (local $l i32) (local $i i32)
  (local $idx i32)
...
(func $decr
  ...
  (local $borrow i32) (local $i i32) (local $idx i32) (local $x i64)
...
(func $sub
  ...
  (param $carry_in i32) (result i32)
  (local $borrow i32) (local $i i32) (local $x i64)
  (local.set $borrow (i32.eqz (local.get $carry_in)))
  (loop $loop
    (if (i32.lt_s (local.get $i) (local.get $l2))
      (then
...
(func $sub_nat (export "sub_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $len2 (ref eq))
  (param $carry (ref eq)) (result (ref eq))
  (ref.i31
    (call $sub (call $get_data (local.get $nat1))
      (call $int (local.get $ofs1)) (call $int (local.get $len1))
      (call $get_data (local.get $nat2)) (call $int (local.get $ofs2))
      (call $int (local.get $len2)) (call $int (local.get $carry))))
)
...
(func $mult_digit
  ...
  (local $a i32) (local $i i32) (local $carry i64) (local $b i64)
  ...
  (loop $loop
    (if (i32.lt_s (local.get $i) (local.get $l2))
      (then
        ...
        (local.set $x1
          (i64.add
            (i64.add
              ...
              (i64.mul (local.get $b)
                (i64.extend_i32_u
                  (i32.and (local.get $a) (i32.const 0xffff)))))
            (local.get $carry)))
        ;; x2 = b*(a >>> 16)
        (local.set $x2
          (i64.mul (local.get $b)
        ...
        (br $loop))))
  (if
    (i32.and (i32.lt_s (local.get $l2) (local.get $l1))
    ...
    (then
      (return_call $add (local.get $d1)
        ...
        (struct.get $nat $dat
          (call $single (i32.wrap_i64 (local.get $carry)))) (i32.const 0)
        (i32.const 1) (i32.const 0))))
  (i32.wrap_i64 (local.get $carry))
)

(func $mult_digit_nat (export "mult_digit_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $len2 (ref eq))
  (param $nat3 (ref eq)) (param $ofs3 (ref eq)) (result (ref eq))
  (ref.i31
    (call $mult_digit (call $get_data (local.get $nat1))
      (call $int (local.get $ofs1)) (call $int (local.get $len1))
      (call $get_data (local.get $nat2)) (call $int (local.get $ofs2))
      (call $int (local.get $len2)) (call $get_data (local.get $nat3))
      (call $int (local.get $ofs3))))
)
      ...
      (then
        (local.set $carry
          (i32.add (local.get $carry)
            (call $mult_digit (local.get $d1)
              (i32.add (local.get $o1) (local.get $i))
              (i32.sub (local.get $l1) (local.get $i)) (local.get $d2)
              (local.get $o2) (local.get $l2) (local.get $d3)
              (i32.add (local.get $o3) (local.get $i)))))
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop))))
  (local.get $carry)
)

(func $mult_nat (export "mult_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $len2 (ref eq))
  (param $nat3 (ref eq)) (param $ofs3 (ref eq)) (param $len3 (ref eq))
  (result (ref eq))
  (ref.i31
    (call $mult (call $get_data (local.get $nat1))
      (call $int (local.get $ofs1)) (call $int (local.get $len1))
      (call $get_data (local.get $nat2)) (call $int (local.get $ofs2))
      (call $int (local.get $len2)) (call $get_data (local.get $nat3))
      (call $int (local.get $ofs3)) (call $int (local.get $len3))))
)

(func $square_nat (export "square_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $len2 (ref eq))
  (result (ref eq))
  ...
  (local.set $carry
    (call $add (local.get $d1) (local.get $o1) (local.get $l1) (local.get $d1)
      (local.get $o1) (local.get $l1) (i32.const 0)))
  (local.set $carry
    (i32.add (local.get $carry)
      (call $mult (local.get $d1) (local.get $o1) (local.get $l1)
        (local.get $d2) (local.get $o2) (local.get $l2) (local.get $d2)
        (local.get $o2) (local.get $l2))))
...
(func $shift_left
  ...
  (local $i i32) (local $wrap i32) (local $idx i32) (local $a i32)
      ...
      (then
        ...
        (array.set $digits (local.get $d1) (local.get $idx)
          (i32.or (i32.shl (local.get $a) (local.get $nbits))
            (local.get $wrap)))
        (local.set $wrap
          (i32.shr_u (local.get $a)
            (i32.sub (i32.const 32) (local.get $nbits))))
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $loop))))
  (array.set $digits (local.get $d2) (local.get $o2) (local.get $wrap))
)

(func $shift_left_nat (export "shift_left_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $nbits (ref eq))
  (result (ref eq))
  (call $shift_left (call $get_data (local.get $nat1))
    (call $int (local.get $ofs1)) (call $int (local.get $len1))
    (call $get_data (local.get $nat2)) (call $int (local.get $ofs2))
    (call $int (local.get $nbits)))
  (ref.i31 (i32.const 0))
)
...
(func $shift_right_nat (export "shift_right_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $nbits (ref eq))
  (result (ref eq))
  (call $shift_right (call $get_data (local.get $nat1))
    (call $int (local.get $ofs1)) (call $int (local.get $len1))
    (call $get_data (local.get $nat2)) (call $int (local.get $ofs2))
    (call $int (local.get $nbits)))
  (ref.i31 (i32.const 0))
    ...
    (if (i32.ge_s (local.get $i) (i32.const 0))
      (then
        ...
        (local.set $y
          (array.get $digits (local.get $d2)
            (i32.add (local.get $o2) (local.get $i))))
        (if (i32.gt_u (local.get $x) (local.get $y))
...
(func $compare_nat (export "compare_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $len2 (ref eq))
  (result (ref eq))
  (ref.i31
    (call $compare (call $get_data (local.get $nat1))
      (call $int (local.get $ofs1)) (call $int (local.get $len1))
      (call $get_data (local.get $nat2)) (call $int (local.get $ofs2))
      (call $int (local.get $len2))))
)

(func $compare_digits_nat (export "compare_digits_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $nat2 (ref eq))
  (param $ofs2 (ref eq)) (result (ref eq))
...
(func $land_digit_nat (export "land_digit_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $nat2 (ref eq))
  (param $ofs2 (ref eq)) (result (ref eq))
...
(func $lor_digit_nat (export "lor_digit_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $nat2 (ref eq))
  (param $ofs2 (ref eq)) (result (ref eq))
  (local $d1 (ref $digits)) (local $o1 i32)
  (local.set $d1 (call $get_data (local.get $nat1)))
...
(func $lxor_digit_nat (export "lxor_digit_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $nat2 (ref eq))
  (param $ofs2 (ref eq)) (result (ref eq))
  (local $d1 (ref $digits)) (local $o1 i32)
  (local.set $d1 (call $get_data (local.get $nat1)))
...
(func $div_digit
  (param $dq (ref $digits)) (param $oq i32) (param $dr (ref $digits))
  (param $or i32) (param $d1 (ref $digits)) (param $o1 i32) (param $len i32)
  (param $d2 (ref $digits)) (param $o2 i32)
  (local $rem i32) (local $div i32) (local $i i32) (local $q i32)
  (local.set $rem
    (array.get $digits (local.get $d1)
    ...
    (if (i32.ge_s (local.get $i) (i32.const 0))
      (then
        (call $div_helper (local.get $rem)
          (array.get $digits (local.get $d1)
            (i32.add (local.get $o1) (local.get $i))) (local.get $div))
        (local.set $rem)
        (local.set $q)
...
(func $div_digit_nat (export "div_digit_nat")
  (param $natq (ref eq)) (param $ofsq (ref eq)) (param $natr (ref eq))
  (param $ofsr (ref eq)) (param $nat1 (ref eq)) (param $ofs1 (ref eq))
  (param $len (ref eq)) (param $nat2 (ref eq)) (param $ofs2 (ref eq))
  (result (ref eq))
  (call $div_digit (call $get_data (local.get $natq))
    (call $int (local.get $ofsq)) (call $get_data (local.get $natr))
    (call $int (local.get $ofsr)) (call $get_data (local.get $nat1))
    (call $int (local.get $ofs1)) (call $int (local.get $len))
    (call $get_data (local.get $nat2)) (call $int (local.get $ofs2)))
  (ref.i31 (i32.const 0))
)

(func $div_nat (export "div_nat")
  (param $nat1 (ref eq)) (param $ofs1 (ref eq)) (param $len1 (ref eq))
  (param $nat2 (ref eq)) (param $ofs2 (ref eq)) (param $len2 (ref eq))
  (result (ref eq))
  (local $d1 (ref $digits)) (local $o1 i32) (local $l1 i32)
  (local $d2 (ref $digits)) (local $o2 i32) (local $l2 i32)
  (local $zero (ref $digits)) (local $s i32) (local $d i64)
  (local $a (ref $digits)) (local $i i32) (local $quo i32)
  (local.set $d1 (call $get_data (local.get $nat1)))
  (local.set $o1 (call $int (local.get $ofs1)))
  (local.set $l1 (call $int (local.get $len1)))
  (local.set $d2 (call $get_data (local.get $nat2)))
  ...
  (if (i32.eq (local.get $l2) (i32.const 1))
    (then
      (call $div_digit (local.get $d1) (i32.add (local.get $o1) (i32.const 1))
        (local.get $d1) (local.get $o1) (local.get $d1) (local.get $o1)
        (local.get $l1) (local.get $d2) (local.get $o2))
    ...
    (if (i32.ge_s (local.get $i) (local.get $l2))
      (then
          ...
          (else
            ...
            (call $div_helper
              (array.get $digits (local.get $d1)
                (i32.add (local.get $o1) (local.get $i)))
              (array.get $digits (local.get $d1)
                (i32.sub (i32.add (local.get $o1) (local.get $i))
                  (i32.const 1))) (i32.wrap_i64 (local.get $d)))
            (drop)
            (local.set $quo)))
        ;; a := nat2 * quo
        (call $set_zero (local.get $a) (i32.const 0)
          (i32.add (local.get $l2) (i32.const 1)))
        (drop
          (call $mult_digit (local.get $a) (i32.const 0)
            (i32.add (local.get $l2) (i32.const 1)) (local.get $d2)
            (local.get $o2) (local.get $l2)
        ...
        (drop
          (call $sub (local.get $d1)
            ...
            (i32.add (local.get $l2) (i32.const 1)) (local.get $a)
            (i32.const 0) (i32.add (local.get $l2) (i32.const 1))
            (i32.const 1)))
        (loop $loop2
          (if
            (i32.or
              (i32.ne
                (array.get $digits (local.get $d1)
                  (i32.add (local.get $o1) (local.get $i))) (i32.const 0))
              (i32.ge_s
                (call $compare (local.get $d1)
                  (i32.sub (i32.add (local.get $o1) (local.get $i))
                    (local.get $l2)) (local.get $l2) (local.get $d2)
                  (local.get $o2) (local.get $l2)) (i32.const 0)))
            (then
              (local.set $quo (i32.add (local.get $quo) (i32.const 1)))
              (drop
                (call $sub (local.get $d1)
                  (i32.sub (i32.add (local.get $o1) (local.get $i))
                    (local.get $l2)) (i32.add (local.get $l2) (i32.const 1))
