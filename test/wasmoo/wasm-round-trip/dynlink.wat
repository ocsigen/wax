...
(func $caml_dynlink_lookup_symbol (export "caml_dynlink_lookup_symbol")
  (param (ref eq) (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)

(func $caml_dynlink_add_primitive (export "caml_dynlink_add_primitive")
  (param (ref eq)) (result (ref eq))
  (local $idx i32)
  (local.set $idx
    (i31.get_u
...
(func $caml_dynlink_get_current_libs (export "caml_dynlink_get_current_libs")
  (param (ref eq)) (result (ref eq))
