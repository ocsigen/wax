...
(func $re_match
  ...
  (local $numregisters i32) (local $group_start (ref $int_array))
  (local $group_end (ref $int_array)) (local $re_register (ref $int_array))
  (local $pc i32) (local $stack (ref null $stack)) (local $u (ref $undo))
  (local $p (ref $pos))
...
(func (export "re_replacement_text")
  ...
  (result (ref eq))
  (local $repl (ref $bytes)) (local $groups (ref $block))
  (local $orig (ref $bytes)) (local $res (ref $bytes)) (local $i i32)
