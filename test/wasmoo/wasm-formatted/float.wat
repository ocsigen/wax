...
(global $infinity (ref $chars)
  (array.new_fixed $chars 8 (@char "i") (@char "n") (@char "f") (@char "i")
...
(func (export "caml_hexstring_of_float")
  ...
  (local $txt (ref $chars)) (local $len i32) (local $s (ref $bytes))
...
(@if $wasi
  (@then
    (func (export "caml_format_float")
      ...
      (local $fmt (ref $bytes)) (local $res (ref $bytes)) (local $d f64)
      (local $buffer i32) (local $out_buffer i32) (local $fmt_len i32)
      (local $avail i32) (local $len i32)
      ...
      (i32.store8 (i32.add (local.get $buffer) (local.get $fmt_len))
        (i32.const 0))
  ...
  (@else
    (func (export "caml_format_float")
      ...
      (local $len i32) (local $c i32) (local $s (ref $bytes))
...
(func $caml_float_of_hex
  ...
  (result f64)
  (local $len i32) (local $c i32) (local $d i32) (local $m i64) (local $f f64)
  (local $negative i32) (local $dec_point i32) (local $exp i32)
  (local $adj i32) (local $n_bits i32) (local $m_bits i32) (local $x_bits i32)
  (local.set $len (array.len (local.get $s)))
...
(func $caml_parse_float (export "caml_parse_float")
  ...
  (local $s' (ref $bytes)) (local $negative i32) (local $c i32) (local $f f64)
...
(func (export "caml_modf_float") (param $v (ref eq)) (result (ref eq))
  (local $x f64) (local $a f64) (local $i f64) (local $f f64)
  (local.set $x (struct.get $float 0 (ref.cast (ref $float) (local.get $v))))
  (local.set $a (f64.abs (local.get $x)))
...
(func $frexp (param $x f64) (result f64 i32)
  (local $y i64) (local $e i32) (local $r_0 f64) (local $r_1 i32)
...
(func (export "caml_frexp_float") (param $v (ref eq)) (result (ref eq))
  (local $r_0 f64) (local $r_1 i32)
  (call $frexp (struct.get $float 0 (ref.cast (ref $float) (local.get $v))))
  (local.set $r_1)
  (local.set $r_0)
  (array.new_fixed $block 3 (ref.i31 (i32.const 0))
...
(func (export "caml_float_compare") (param $x f64) (param $y f64) (result i32)
  (i32.add
