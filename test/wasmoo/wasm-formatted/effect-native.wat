...
(@if (= $effects "native")
  (@then
    ...
    (func $wrapper_cont (param $f (ref eq)) (param (ref eq)) (result (ref eq))
      (return_call_ref $thunk (local.get $f)
    ...
    (func $resume_fiber (export "%resume")
      ...
      (local $fiber (ref $fiber)) (local $res (ref eq)) (local $exn (ref eq))
    ...
    (@if (< $ocaml_version (5 6 0))
      ...
      (@else
        (func (export "%reperform")
          ...
          (local $tail (ref eq)) (local $res_0 (ref eq))
          (local $res_1 (ref eq))
          (local.set $tail
            (array.get $block
              (ref.cast (ref $block) (local.get $continuation))
    ...
    (func (export "%perform") (param $eff (ref eq)) (result (ref eq))
      ...
      (return_call_ref $function_1 (local.get $res_1) (local.get $res_0)
        (struct.get $closure 0 (ref.cast (ref $closure) (local.get $res_0)))))
