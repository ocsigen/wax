...
(func (export "caml_obj_is_stack") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)
...
(func $caml_obj_dup (export "caml_obj_dup")
  ...
  (local $s (ref $bytes)) (local $s' (ref $bytes)) (local $len i32)
...
(func (export "caml_obj_block")
  ...
  (local $res (ref $block)) (local $n i32)
...
(func (export "caml_lazy_make_forward") (param $v (ref eq)) (result (ref eq))
...
(func (export "caml_lazy_reset_to_lazy") (param $v (ref eq)) (result (ref eq))
  (drop
...
(func (export "caml_oo_cache_id") (result (ref eq))
  (local $cacheid i32) (local $a (ref $int_array)) (local $len i32)
...
(func (export "caml_get_cached_method")
  ...
  (result (ref eq))
  (local $meths (ref $block)) (local $tg i32) (local $cacheid i32)
...
(func (export "caml_get_public_method")
  ...
  (local $meths (ref $block)) (local $tg i32) (local $li i32) (local $mi i32)
  (local $hi i32)
  (local.set $meths
    (ref.cast (ref $block)
      (array.get $block (ref.cast (ref $block) (local.get $obj))
...
(func (export "caml_set_oo_id") (param $v (ref eq)) (result (ref eq))
  (local $id i32)
