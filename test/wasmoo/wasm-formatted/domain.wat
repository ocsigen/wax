...
(func (export "caml_atomic_fetch_add_field")
  ...
  (result (ref eq))
  (local $b (ref $block)) (local $old (ref eq)) (local $j i32)
  (local.set $j
    (i32.add (i31.get_u (ref.cast (ref i31) (local.get $i))) (i32.const 1)))
  (local.set $b (ref.cast (ref $block) (local.get $ref)))
...
(func (export "caml_atomic_exchange_field")
  ...
  (result (ref eq))
  (local $b (ref $block)) (local $r (ref eq)) (local $j i32)
  (local.set $j
    (i32.add (i31.get_u (ref.cast (ref i31) (local.get $i))) (i32.const 1)))
  (local.set $b (ref.cast (ref $block) (local.get $ref)))
...
(func (export "caml_domain_count") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)
