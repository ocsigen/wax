...
(func (export "caml_sys_open")
  ...
  (result (ref eq))
  (local $fd i32) (local $flags i32) (local $offset i64) (local $path_0 i32)
  (local $path_1 i32) (local $path_2 i32) (local $res i32) (local $buffer i32)
...
(func (export "caml_ml_open_descriptor_out")
  (param $fd (ref eq)) (result (ref eq))
  (local $res (ref eq)) (local $buffer (ref extern))
  (local.set $buffer (call $ta_new (global.get $IO_BUFFER_SIZE)))
  (local.set $res
    (struct.new $channel (global.get $channel_ops) (call $custom_next_id)
      (i31.get_u (ref.cast (ref i31) (local.get $fd))) (local.get $buffer)
...
(func (export "caml_ml_is_binary_mode") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)
...
(func (export "caml_ml_close_channel") (param $vch (ref eq)) (result (ref eq))
...
(func $read
  ...
  (result i32)
  (local $buffer i32) (local $iovs i32) (local $iovs_len i32)
  (local $nread i32) (local $s (ref $bytes)) (local $res i32)
  (local.set $buffer (call $get_buffer))
...
(func $caml_refill (param $ch (ref $channel)) (result i32)
  (local $n i32) (local $view (ref extern))
...
(func (export "caml_ml_input")
  ...
  (local $len i32) (local $curr i32) (local $avail i32) (local $nread i32)
...
(func $write
  ...
  (result i32)
  (local $buffer i32) (local $iovs i32) (local $iovs_len i32)
  (local $nwritten i32) (local $s (ref $bytes)) (local $res i32)
  (local.set $buffer (call $get_buffer))
  ...
  (loop $write
    ...
    (if (i32.eqz (local.get $res))
      (then
        ...
        (local.set $remaining
          (i32.add (local.get $remaining) (i32.load (local.get $nwritten))))
...
(func $caml_flush_partial (param $ch (ref $channel)) (result i32)
  ...
  (local $buf (ref extern)) (local $tmp (ref $bytes))
...
(func (export "caml_ml_channel_size_64")
  (param $vch (ref eq)) (result (ref eq))
  (call $caml_copy_int64
    (call $file_size (call $caml_ml_get_channel_fd (local.get $vch))))
)
