...
(func (export "caml_realloc_global") (param $len (ref eq)) (result (ref eq))
...
(func (export "caml_reify_bytecode")
  (param $code (ref eq)) (param $debug (ref eq)) (param $digest (ref eq))
  (result (ref eq))
  (local $arr (ref $block)) (local $len i32) (local $i i32)
  (local $chunk (ref $bytes)) (local $chunk_len i32) (local $buf (ref $bytes))
  (local $pos i32)
  (if (ref.test (ref i31) (global.get $toplevel_compile))
    (then
      (call $caml_failwith
...
(@then
(func (export "caml_get_section_table") (param (ref eq)) (result (ref eq))
...
(func (export "wasm_get_bytecode_sections") (param (ref eq)) (result (ref eq))
  (call $get_sections)
)

(func (export "wasm_get_runtime_aliases") (param (ref eq)) (result (ref eq))
...
(func (export "caml_sys_modify_argv") (param (ref eq)) (result (ref eq))
