...
(@then (export "caml_gc_quick_stat" (func $caml_gc_stat))
...
(@else (export "caml_gc_quick_stat" (func $caml_gc_stat))
(func $caml_gc_stat (export "caml_gc_stat") (param (ref eq)) (result (ref eq))
  (local $f (ref eq))
  (local.set $f (struct.new $float (f64.const 0)))
...
(func (export "caml_memprof_is_sampling") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)

(@string $gc_tweak_error "Gc.Tweak: parameter not found" )

(func (export "caml_gc_tweak_get") (param (ref eq)) (result (ref eq))
  (call $caml_invalid_argument (global.get $gc_tweak_error))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gc_tweak_set") (param (ref eq) (ref eq)) (result (ref eq))
  (call $caml_invalid_argument (global.get $gc_tweak_error))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gc_tweak_list_active") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)
