...
(func $caml_getenv (param $name (ref eq)) (result eqref)
  (local $var (ref $bytes)) (local $i i32) (local $j i32) (local $len i32)
...
(func (export "caml_sys_getenv_opt") (param $name (ref eq)) (result (ref eq))
  (local $res eqref)
  (local.set $res (call $caml_getenv (local.get $name)))
...
(func $caml_sys_argv (export "caml_sys_argv")
  ...
  (local $buffer i32) (local $res i32) (local $argc i32) (local $argv_ptr i32)
  (local $argv_buf i32) (local $args (ref $block)) (local $arg i32)
  (local $i i32)
...
(func (export "caml_sys_proc_self_exe") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)
...
(func (export "caml_sys_random_seed") (param (ref eq)) (result (ref eq))
  ...
  (local $n i32) (local $buffer i32) (local $res i32)
...
(func (export "caml_sys_const_ostype_unix") (param (ref eq)) (result (ref eq))
...
(func (export "caml_sys_const_arch_amd64") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.eqz (global.get $on_arm64)))
)

(func (export "caml_sys_const_arch_arm64") (param (ref eq)) (result (ref eq))
...
(@if $wasi
(@then
(func (export "caml_sys_isatty") (param $ch (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
) )
(@else
(func (export "caml_sys_isatty") (param $ch (ref eq)) (result (ref eq))
...
(func (export "caml_sys_const_runtime5") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 1))
)
