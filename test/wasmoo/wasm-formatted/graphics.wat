...
(@if (not $wasi)
  (@then
    ...
    (func (export "caml_gr_fill_poly") (param $ar (ref eq)) (result (ref eq))
      ...
      (local $flat (ref extern)) (local $i i32) (local $n i32)
      (call $check_state)
    ...
    (func (export "caml_gr_make_image")
      ...
      (local $a (ref $block)) (local $row (ref $block))
      (local $flat (ref extern)) (local $h i32) (local $w i32) (local $i i32)
      (local $j i32) (local $idx i32)
      (call $check_state)
