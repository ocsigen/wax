...
(func (export "caml_gr_open_graph") (param $s (ref eq)) (result (ref eq))
  (if
    (call $gr_open
...
(func (export "caml_gr_close_graph") (param (ref eq)) (result (ref eq))
  (call $check_state)
  (call $gr_close)
  (ref.i31 (i32.const 0))
)

(func (export "caml_gr_clear_graph") (param (ref eq)) (result (ref eq))
  (call $check_state)
  (call $gr_clear)
  (ref.i31 (i32.const 0))
)
...
(func (export "caml_gr_size_x") (param (ref eq)) (result (ref eq))
  (call $check_state)
  (ref.i31 (call $gr_size_x))
)

(func (export "caml_gr_size_y") (param (ref eq)) (result (ref eq))
  (call $check_state)
  (ref.i31 (call $gr_size_y))
)

(func (export "caml_gr_current_x") (param (ref eq)) (result (ref eq))
  (call $check_state)
  (ref.i31 (call $gr_current_x))
)

(func (export "caml_gr_current_y") (param (ref eq)) (result (ref eq))
  (call $check_state)
...
(func (export "caml_gr_set_color") (param $c (ref eq)) (result (ref eq))
  (call $check_state)
...
(func (export "caml_gr_set_line_width") (param $w (ref eq)) (result (ref eq))
  (call $check_state)
...
(func (export "caml_gr_draw_char") (param $c (ref eq)) (result (ref eq))
  (call $check_state)
  (call $gr_draw_char (i31.get_s (ref.cast (ref i31) (local.get $c))))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gr_draw_string") (param $s (ref eq)) (result (ref eq))
  (call $check_state)
  (call $gr_draw_str
    (call $unwrap (call $caml_jsstring_of_string (local.get $s))))
  (ref.i31 (i32.const 0))
...
(func (export "caml_gr_set_font") (param $s (ref eq)) (result (ref eq))
  (call $check_state)
  (call $gr_set_font
    (call $unwrap (call $caml_jsstring_of_string (local.get $s))))
  (ref.i31 (i32.const 0))
...
(func (export "caml_gr_set_text_size") (param $s (ref eq)) (result (ref eq))
  (call $check_state)
...
(func (export "caml_gr_text_size") (param $s (ref eq)) (result (ref eq))
  (call $check_state)
...
(func (export "caml_gr_fill_poly") (param $ar (ref eq)) (result (ref eq))
  (local $a (ref $block)) (local $p (ref $block)) (local $flat (ref extern))
...
(func (export "caml_gr_make_image") (param $arr (ref eq)) (result (ref eq))
  (local $a (ref $block)) (local $row (ref $block)) (local $flat (ref extern))
  (local $h i32) (local $w i32) (local $i i32) (local $j i32) (local $idx i32)
  (call $check_state)
...
(func (export "caml_gr_dump_image") (param $im (ref eq)) (result (ref eq))
  (local $js_im anyref) (local $w i32) (local $h i32)
  (local $result (ref $block)) (local $row (ref $block)) (local $i i32)
  (local $j i32)
...
(func (export "caml_gr_state_get") (param (ref eq)) (result (ref eq))
  (call $check_state)
  (call $wrap (call $gr_state))
)

(func (export "caml_gr_state_set") (param $s (ref eq)) (result (ref eq))
...
(func (export "caml_gr_doc_of_state") (param $s (ref eq)) (result (ref eq))
  (call $wrap (call $gr_doc_of_state (call $unwrap (local.get $s))))
)

;; --- Stubs returning unit ---

(func (export "caml_gr_sigio_handler") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gr_sigio_signal") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)

;; --- Stubs raising Failure ---

(func (export "caml_gr_wait_event") (param (ref eq)) (result (ref eq))
  (call $caml_failwith (global.get $wait_event))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gr_synchronize") (param (ref eq)) (result (ref eq))
  (call $caml_failwith (global.get $synchronize))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gr_remember_mode") (param (ref eq)) (result (ref eq))
  (call $caml_failwith (global.get $remember_mode))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gr_display_mode") (param (ref eq)) (result (ref eq))
  (call $caml_failwith (global.get $display_mode))
  (ref.i31 (i32.const 0))
)

(func (export "caml_gr_window_id") (param (ref eq)) (result (ref eq))
...
(func (export "caml_gr_close_subwindow") (param (ref eq)) (result (ref eq))
