...
(@if $wasi
  (@then
    ...
    (func (export "unix_utimes") (export "caml_unix_utimes")
      ...
      (result (ref eq))
      (local $p_fd i32) (local $p_addr i32) (local $p_len i32)
      (local $atim i64) (local $mtim i64) (local $set_to_now i32)
      (local $res i32) (local $at f64) (local $mt f64)
...
(@if $wasi
  (@then
    ...
    (func $readdir_helper (param $vdir (ref eq)) (result (ref eq))
      ...
      (local $namelen i32) (local $entry i32) (local $size i32)
...
(@if $wasi
  (@then
    (func (export "unix_write") (export "caml_unix_write")
      ...
      (local $buffer i32) (local $res i32) (local $iovs i32)
      (local $iovs_len i32) (local $nwritten i32) (local $fd i32)
    ...
    (func (export "unix_read") (export "caml_unix_read")
      ...
      (param $vlen (ref eq)) (result (ref eq))
      (local $buffer i32) (local $res i32) (local $iovs i32)
      (local $iovs_len i32) (local $nread i32) (local $fd i32)
  ...
  (@else
    ...
    (func (export "unix_write_bigarray") (export "caml_unix_write_bigarray")
      ...
      (local $len i32) (local $n i32) (local $written i32)
      (local $fd_offset (ref $fd_offset)) (local $offset i64)
      (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
    ...
    (func (export "unix_read_bigarray") (export "caml_unix_read_bigarray")
      ...
      (param $vlen (ref eq)) (result (ref eq))
      (local $fd i32) (local $buf (ref extern)) (local $pos i32)
      (local $len i32) (local $n i32) (local $fd_offset (ref $fd_offset))
      (local $offset i64)
      (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
      (local.set $buf (call $caml_ba_get_data (local.get $vbuf)))
      (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
