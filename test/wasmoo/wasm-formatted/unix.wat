...
(import "bindings" "isatty" (func $isatty (param (ref eq)) (result (ref eq))))
...
(@string $code_str "code" ) (@string $errno_str "errno" )
(@string $indexOf "indexOf" ) (@string $syscall "syscall" )
(@string $path "path" )

(func $caml_unix_error (param $exception externref) (param $cmd eqref)
  (local $exn (ref eq)) (local $code (ref eq)) (local $errno (ref eq))
...
(func (export "caml_unix_gmtime") (export "unix_gmtime")
  (param $t (ref eq)) (result (ref eq))
  (call $gmtime (struct.get $float 0 (ref.cast (ref $float) (local.get $t))))
) ) )
...
(func (export "caml_unix_mktime") (export "unix_mktime")
  ...
  (i32.store offset=32 (local.get $tm) (i32.const -1))
...
(@if $wasi
(@then (@string $utimes_str "utimes" )

(func (export "unix_utimes") (export "caml_unix_utimes")
  (param $path (ref eq)) (param $atime (ref eq)) (param $mtime (ref eq))
  (result (ref eq))
  (local $p_fd i32) (local $p_addr i32) (local $p_len i32) (local $atim i64)
  (local $mtim i64) (local $set_to_now i32) (local $res i32) (local $at f64)
  (local $mt f64)
...
(func $alloc_stat (param $large i32) (param $p i32) (result (ref eq))
  (array.new_fixed $block 13 (ref.i31 (i32.const 0))
    ...
    (if (result (ref eq)) (local.get $large)
      (then (call $caml_copy_int64 (i64.load offset=32 (local.get $p))))
      (else (ref.i31 (i32.wrap_i64 (i64.load offset=32 (local.get $p))))))
    (struct.new $float
...
(func $stat
  ...
  (local $p_fd i32) (local $p_addr i32) (local $p_len i32) (local $buffer i32)
  (local $res i32)
...
(func (export "unix_rename") (export "caml_unix_rename")
  ...
  (local $np_fd i32) (local $np_addr i32) (local $np_len i32) (local $res i32)
  (local $arg (ref eq))
...
(func $unix_opendir (export "unix_opendir") (export "caml_unix_opendir")
  ...
  (call $caml_unix_error_if (local.get $res) (global.get $opendir_str)
    (local.get $name))
  (struct.new $directory (i32.load (local.get $buffer))
...
(func $is_dot_entry (param $addr i32) (param $len i32) (result i32)
  ...
  (if (i32.eq (local.get $len) (i32.const 1))
    (then (return (i32.eq (i32.load8_u (local.get $addr)) (i32.const 0x2e)))))
  (if (i32.eq (local.get $len) (i32.const 2))
    (then
      (return
        (i32.and (i32.eq (i32.load8_u (local.get $addr)) (i32.const 0x2e))
...
(func (export "unix_link") (export "caml_unix_link")
  ...
  (local $flags i32) (local $res i32) (local $arg (ref eq))
  ;; Resolve both paths without raising, so that the first buffer is
  ;; always freed below even if resolving the second path fails.
  (call $wasi_resolve_path (local.get $o))
  (local.set $op_len)
...
(@if $wasi
(@then (@string $readlink_str "readlink" )
...
(@if $wasi
(@then (@string $truncate_str "truncate" )

(func $truncate_impl (param $path (ref eq)) (param $len i64) (result (ref eq))
  (local $p_fd i32) (local $p_addr i32) (local $p_len i32) (local $fd i32)
...
(func (export "unix_open") (export "caml_unix_open")
  ...
  (result (ref eq))
  (local $flags i32) (local $offset i64) (local $path_fd i32)
  (local $path_addr i32) (local $path_len i32) (local $res i32)
  (local $buffer i32)
...
(func (export "unix_write") (export "caml_unix_write")
  ...
  (local $buffer i32) (local $res i32) (local $iovs i32) (local $iovs_len i32)
  (local $nwritten i32) (local $fd i32) (local $s (ref $bytes))
  (local $pos i32) (local $len i32) (local $numbytes i32) (local $written i32)
  (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
...
(func (export "unix_read") (export "caml_unix_read")
  ...
  (param $vlen (ref eq)) (result (ref eq))
  (local $buffer i32) (local $res i32) (local $iovs i32) (local $iovs_len i32)
  (local $nread i32) (local $fd i32) (local $pos i32) (local $len i32)
  (local $n i32)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
  (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
...
(func (export "unix_read_bigarray") (export "caml_unix_read_bigarray")
  ...
  (param $vlen (ref eq)) (result (ref eq))
  (local $fd i32) (local $dat (ref $dat)) (local $buf (ref $bytes))
  (local $pos i32) (local $len i32) (local $n i32) (local $buffer i32)
...
(func (export "unix_write") (export "caml_unix_write")
  ...
  (local $buf_view (ref extern)) (local $pos i32) (local $len i32)
  (local $numbytes i32) (local $written i32) (local $n i32)
...
(func (export "unix_single_write") (export "caml_unix_single_write")
  ...
  (local $fd i32) (local $s (ref $bytes)) (local $buf (ref extern))
  (local $buf_view (ref extern)) (local $pos i32) (local $len i32)
  (local $numbytes i32) (local $n i32) (local $fd_offset (ref $fd_offset))
  (local $offset i64)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $s (ref.cast (ref $bytes) (local.get $vbuf)))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
...
(func (export "unix_read") (export "caml_unix_read")
  (param $vfd (ref eq)) (param $vbuf (ref eq)) (param $vpos (ref eq))
  (param $vlen (ref eq)) (result (ref eq))
  (local $fd i32) (local $buf (ref extern)) (local $buf_view (ref extern))
...
(func (export "unix_write_bigarray") (export "caml_unix_write_bigarray")
  ...
  (local $n i32) (local $written i32) (local $fd_offset (ref $fd_offset))
  (local $offset i64)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
...
(func (export "unix_read_bigarray") (export "caml_unix_read_bigarray")
  ...
  (param $vlen (ref eq)) (result (ref eq))
  (local $fd i32) (local $buf (ref extern)) (local $pos i32) (local $len i32)
  (local $n i32) (local $fd_offset (ref $fd_offset)) (local $offset i64)
  (local.set $fd (i31.get_u (ref.cast (ref i31) (local.get $vfd))))
  (local.set $buf (call $caml_ba_get_data (local.get $vbuf)))
  (local.set $pos (i31.get_u (ref.cast (ref i31) (local.get $vpos))))
  (local.set $len (i31.get_u (ref.cast (ref i31) (local.get $vlen))))
...
(func $channel_of_descr_name (param $out i32) (result (ref eq))
  (select (result (ref eq)) (global.get $out_channel_of_descr)
...
(func $caml_unix_check_stream_semantics (param $fd (ref eq)) (param $out i32)
  (local $s (ref $block)) (local $kind i32) (local $buffer i32)
  (local $res i32) (local $file_type i32)
  (local.set $buffer (call $get_buffer))
  (local.set $res
    (call $fd_filestat_get (i31.get_u (ref.cast (ref i31) (local.get $fd)))
      (local.get $buffer)))
...
(@else (export "unix_isatty" (func $isatty))
