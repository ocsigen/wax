...
(@if $wasi
  (@then
    ...
    (func $map_get (param $map (ref any)) (param $k (ref eq)) (result i31ref)
      (local $m (ref $map)) (local $keys (ref $block)) (local $i i32)
      (local $size i32)
...
(@string $err_expected_size "input_value: expected a fixed-size custom block")
...
(func $intern_custom
  ...
  (local $r_0 (ref eq)) (local $r_1 i32)
  (block $unknown
    (local.set $ops
      (br_on_null $unknown
...
(func $intern_rec
  ...
  (local $next (ref null $stack_item)) (local $item (ref $stack_item))
  (local $code i32) (local $header i32) (local $tg i32) (local $size i32)
  (local $len i32) (local $pos i32) (local $pos' i32) (local $ofs i32)
  (local $b (ref $block)) (local $str (ref $bytes)) (local $v (ref eq))
...
(func $reserve_extern_output
  ...
  (local $pos i32) (local $extra i32) (local $buf (ref $bytes))
...
(func $extern_custom
  ...
  (local $buf (ref $bytes)) (local $r_0 i32) (local $r_1 i32)
...
(func $extern_rec (param $s (ref $extern_state)) (param $v (ref eq))
  ...
  (local $flv (ref $float)) (local $blk (ref $block))
...
(func (export "caml_output_value_to_string")
  ...
  (local $r_0 i32) (local $r_1 (ref $bytes)) (local $blk (ref $output_block))
  (local $pos i32) (local $len i32) (local $res (ref $bytes))
  (local.set $blk
...
(func (export "caml_output_value_to_buffer")
  ...
  (param $v (ref eq)) (param $flags (ref eq)) (result (ref eq))
  (local $dat (ref $bytes)) (local $pos i32) (local $len i32) (local $r_0 i32)
  (local $r_1 (ref $bytes)) (local $blk (ref $output_block))
