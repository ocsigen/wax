...
(func (export "caml_list_to_js_array") (param $v (ref eq)) (result (ref eq))
...
(func (export "caml_list_of_js_array") (param $v (ref eq)) (result (ref eq))
...
(func (export "caml_wrap_exception") (param $vexn externref) (result (ref eq))
  (local $exn anyref)
