...
(@if (not $wasi)
  (@then
    ...
    (import "bindings" "new"
      (func $new (param anyref anyref) (result anyref)))
    ...
    (func (export "caml_js_to_float") (param $v (ref eq)) (result (ref eq))
      (struct.new $float (call $to_float (call $unwrap (local.get $v)))))

    (func (export "caml_js_from_float") (param $v (ref eq)) (result (ref eq))
      (return_call $wrap
        (call $from_float
          (struct.get $float 0 (ref.cast (ref $float) (local.get $v))))))

    (func (export "caml_js_to_bool") (param $v (ref eq)) (result (ref eq))
    ...
    (func (export "caml_js_from_int32") (param $v (ref eq)) (result (ref eq))
      (return_call $wrap (call $from_int32 (call $Int32_val (local.get $v)))))

    (func (export "caml_js_to_nativeint")
      (param $v (ref eq)) (result (ref eq))
      (return_call $caml_copy_nativeint
        (call $to_int32 (call $unwrap (local.get $v)))))

    (func (export "caml_js_from_nativeint")
      (param $v (ref eq)) (result (ref eq))
      (return_call $wrap
        (call $from_int32 (call $Nativeint_val (local.get $v)))))
    ...
    (func (export "caml_js_delete")
      ...
      (if (ref.test (ref $bytes) (local.get $f))
        (then (local.set $f (call $caml_jsbytes_of_bytes (local.get $f)))))
      (call $delete (call $unwrap (local.get $o))
        (call $unwrap (local.get $f)))
      (ref.i31 (i32.const 0)))
    ...
    (func (export "caml_js_typeof") (param $v (ref eq)) (result (ref eq))
    ...
    (func (export "caml_js_object") (param $va (ref eq)) (result (ref eq))
      (local $a (ref $block)) (local $p (ref $block)) (local $i i32)
      (local $l i32) (local $js anyref)
    ...
    (func $caml_js_from_array (export "caml_js_from_array")
      ...
      (drop
        (block $not_array (result (ref eq))
          (local.set $a
            (br_on_cast_fail $not_array (ref eq) (ref $block)
              (local.get $va)))
    ...
    (func (export "caml_js_to_array") (param $v (ref eq)) (result (ref eq))
    ...
    (func $caml_jsbytes_of_bytes (export "caml_jsbytes_of_string")
      (param $vs (ref eq)) (result (ref eq))
      (local $s (ref $bytes)) (local $s' (ref $bytes)) (local $l i32)
    ...
    (func (export "caml_wrap_exception")
        ...
        (then
          (if
            (ref.eq (array.get $block (local.get $exn) (i32.const 1))
              (call $caml_named_value (global.get $jsError)))
            (then
              (return (array.get $block (local.get $exn) (i32.const 2)))))))
