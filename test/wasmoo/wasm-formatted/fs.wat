...
(func $wasi_resolve_path (export "wasi_resolve_path")
  ...
  (local $res_0 i32) (local $res_1 (ref $bytes)) (local $p i32)
...
(func (export "caml_sys_getcwd") (export "unix_getcwd")
...
(func (export "caml_sys_read_directory")
  ...
  (local $p_fd i32) (local $p_addr i32) (local $p_len i32) (local $buffer i32)
  (local $res i32) (local $fd i32) (local $buf i32) (local $new_buf i32)
  (local $size i32) (local $pos i32) (local $available i32) (local $left i32)
...
(@if $wasi
(@then
(func (export "caml_sys_rmdir") (param $name (ref eq)) (result (ref eq))
  (return_call $sys_path_op (local.get $name)
...
(func (export "caml_list_mount_point") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)

(func (export "caml_unmount") (param (ref eq)) (result (ref eq))
  (ref.i31 (i32.const 0))
)
