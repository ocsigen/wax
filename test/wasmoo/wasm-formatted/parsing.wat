...
(func (export "caml_parse_engine")
  ...
  (local $tbl_defred (ref $bytes)) (local $tbl_sindex (ref $bytes))
  (local $tbl_check (ref $bytes)) (local $tbl_rindex (ref $bytes))
  (local $tbl_table (ref $bytes)) (local $tbl_len (ref $bytes))
  (local $tbl_lhs (ref $bytes)) (local $tbl_gindex (ref $bytes))
