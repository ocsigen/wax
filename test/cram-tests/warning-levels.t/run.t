...
An unknown warning or group name is rejected:
  ...
  wax: option '-W': Unknown warning or group 'bogus'. Known names:
       ...
       unnecessary-mut, shift-count-overflow, constant-trap,
       tautological-comparison, constant-condition, unused-result, dead-code,
       cast-always-fails, eager-select, precedence, redundant-operation,
       truncated-coverage, naming-conflict, reserved-word-rename,
       generated-name, compound-assignment, field-punning,
       redundant-annotation, confusable-unicode, unused, correctness,
       redundant, naming, suggestion, all.
  [124]
