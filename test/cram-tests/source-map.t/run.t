...
previous instruction's location. It lands between the two mapped `ref.func`
positions, so — unlike a leading absent segment, which resets nothing and is
dropped — it survives to close off the `const` initializer's mapping.
