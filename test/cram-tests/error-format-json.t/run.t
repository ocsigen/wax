...
A type error, as JSON (still exit 128):
  ...
  {"severity":"error","file":"bad.wax","startLine":1,"startColumn":16,"endLine":1,"endColumn":19,"startOffset":16,"endOffset":19,"message":"This expression has type 'float' but is expected to have type 'i32'.","warning":null,"hint":null,"related":[]}
  [128]
